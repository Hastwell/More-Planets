...
public class SkyProviderDarkAsteroids extends IRenderHandler
{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		var23.getWorldRenderer().addVertex(-var12, 90.0D, -var12);
		var23.getWorldRenderer().addVertex(var12, 90.0D, -var12);
		var23.getWorldRenderer().addVertex(var12, 90.0D, var12);
		var23.getWorldRenderer().addVertex(-var12, 90.0D, var12);
		var23.draw();
		...
		var23.getWorldRenderer().startDrawingQuads();
		var23.getWorldRenderer().addVertexWithUV(-var12, 90.0D, -var12, 0.0D, 0.0D);
		var23.getWorldRenderer().addVertexWithUV(var12, 90.0D, -var12, 1.0D, 0.0D);
		var23.getWorldRenderer().addVertexWithUV(var12, 90.0D, var12, 1.0D, 1.0D);
		var23.getWorldRenderer().addVertexWithUV(-var12, 90.0D, var12, 0.0D, 1.0D);
		var23.draw();
		...
		for (int var3 = 0; var3 < (ConfigManagerCore.moreStars ? 35000 : 6000); ++var3)
		{
			...
			if (var12 < 1.0D && var12 > 0.01D)
			{
				...
				for (int i = 0; i < 4; ++i)
				{
					...
					var2.getWorldRenderer().addVertex(pX + dX, pY + dY, pZ + dZ);
				}
			}
		}
		var2.draw();
