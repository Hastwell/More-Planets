...
public class RenderIceCrystalMeteorChunk extends Render<EntityIceCrystalMeteorChunk>
{
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityIceCrystalMeteorChunk entity)
    {
        return this.meteorChunkTexture;
    }

    @Override
    public void doRender(EntityIceCrystalMeteorChunk entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
