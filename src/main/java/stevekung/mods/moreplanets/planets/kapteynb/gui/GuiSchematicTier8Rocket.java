...
package stevekung.mods.moreplanets.planets.kapteynb.gui;
...
{
    private static ResourceLocation tier8SchematicTexture = new ResourceLocation("kapteynb:textures/gui/schematic_tier8_rocket.png");
    private int pageIndex;

    public GuiSchematicTier8Rocket(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new ContainerSchematicTier8Rocket(par1InventoryPlayer, x, y, z));
        this.ySize = 238;
    }
    ...
    {
        this.fontRendererObj.drawString(GCCoreUtil.translate("schematics.container.rocket.tier8"), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(GuiSchematicTier8Rocket.tier8SchematicTexture);
