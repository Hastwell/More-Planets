...
public class RenderFrozenSludgeling extends RenderLiving<EntityFrozenSludgeling>
{
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityFrozenSludgeling entity)
    {
        return this.texture;
    }
}