...
public class MapGenKapteynBRavine extends MapGenBase
{
                            ...
                            for (j3 = k4; j3 < j2; ++j3)
                            {
                                ...
                                if (d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    for (int l3 = i2 - 1; l3 >= j4; --l3)
                                    {
                                        ...
                                        {
                                            if (this.isTopBlock(p_151540_5_, k3, k2, l3, j3, p_151540_3_, p_151540_4_))
                                            {
                                                flag = true;
                                            }

                                            this.digBlock(p_151540_5_, k3, k2, l3, j3, p_151540_3_, p_151540_4_, flag);
                                        }
    ...
    protected void digBlock(Block[] data, int index, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop)
    {
        ...
        if (block == KapteynBBlocks.kapteyn_b_block || block == KapteynBBlocks.kapteyn_b_ice || block == filler || block == top)
        {
            if (y < 20)
            {
                data[index] = KapteynBBlocks.frozen_water;
            }
            else if (y < 10)
            {
