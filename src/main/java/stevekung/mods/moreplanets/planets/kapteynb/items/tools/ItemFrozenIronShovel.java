...
public class ItemFrozenIronShovel extends ItemSpade
{
    public ItemFrozenIronShovel(String name, ToolMaterial par2EnumToolMaterial)
    {
    ...
    {
        this.itemIcon = par1IconRegister.registerIcon("kapteynb:frozen_iron_shovel");
    }
