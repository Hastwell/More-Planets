...
public class Tier8RocketRecipeHandlerMP extends RocketRecipeHandlerMP
{
    public String getRecipeId()
    {
        return "galacticraft.tier8.rocket";
    }

    public Set<Entry<ArrayList<PositionedStack>, PositionedStack>> getRecipes()
    {
        return NEIKapteynBConfig.getRocketBenchRecipes();
    }
    ...
    {
        return "kapteynb:textures/gui/schematic_tier8_rocket.png";
    }
}