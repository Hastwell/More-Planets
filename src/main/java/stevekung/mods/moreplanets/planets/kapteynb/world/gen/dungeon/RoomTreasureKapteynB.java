...
public class RoomTreasureKapteynB extends DungeonRoom
{
    ...
    public RoomTreasureKapteynB(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
    {
    ...
    public void generate(ChunkPrimer chunk, int cx, int cz)
    {
        ...
        if (this.placeBlock(chunk, hx, this.posY, hz, cx, cz, KapteynBBlocks.kapteyn_b_treasure_chest, 0))
        {
    ...
    {
        return new RoomTreasureKapteynB(dungeon, x, y, z, facing);
    }
}