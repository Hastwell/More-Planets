...
public class BlockT8KapteynBTreasureChest extends BlockTreasureChestMP
{
    public BlockT8KapteynBTreasureChest(String name)
    {
        super();
    ...
    {
        final TileEntityKapteynBTreasureChest var7 = (TileEntityKapteynBTreasureChest) par1World.getTileEntity(par2, par3, par4);
    ...
    {
        return "kapteynb:kapteyn_b_treasure_chest";
    }

    @Override
    public TileEntityTreasureChestMP getTreasureChest()
    {
        return new TileEntityKapteynBTreasureChest();
    }
}