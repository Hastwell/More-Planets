...
public class EntityTier8Rocket extends EntityTieredRocket
{
    ...
    {
        return new ItemStack(KapteynBItems.tier8_rocket, 1, this.rocketType.getIndex());
    }
    ...
    public void onTeleport(EntityPlayerMP player)
    {
        ...
        if (playerBase != null)
        {
            ...
            stats.rocketItem = KapteynBItems.tier8_rocket;
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
    {
        ...
        ItemStack rocket = new ItemStack(KapteynBItems.tier8_rocket, 1, this.rocketType.getIndex());
