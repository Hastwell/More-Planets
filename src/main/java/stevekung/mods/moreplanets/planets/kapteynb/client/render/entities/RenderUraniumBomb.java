...
public class RenderUraniumBomb extends Render
{
	...
	public void doRender(EntityUraniumBomb entity, double x, double y, double z, float p_76986_8_, float partialTicks)
	{
		...
		blockrendererdispatcher.renderBlockBrightness(KapteynBBlocks.uranium_bomb.getDefaultState(), entity.getBrightness(partialTicks));
		...
		if (entity.fuse / 5 % 2 == 0)
		{
			...
			blockrendererdispatcher.renderBlockBrightness(KapteynBBlocks.uranium_bomb.getDefaultState(), 1.0F);
