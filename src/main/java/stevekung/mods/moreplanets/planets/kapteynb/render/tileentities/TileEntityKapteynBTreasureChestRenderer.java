...
public class TileEntityKapteynBTreasureChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation treasureChestTexture = new ResourceLocation("kapteynb:textures/model/kapteyn_b_treasure_chest.png");

    private final ModelTreasureChest chestModel = new ModelTreasureChest();

    public void renderTileEntityTreasureChestAt(TileEntityKapteynBTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        this.bindTexture(TileEntityKapteynBTreasureChestRenderer.treasureChestTexture);
    ...
    {
        this.renderTileEntityTreasureChestAt((TileEntityKapteynBTreasureChest) par1TileEntity, par2, par4, par6, par8);
    }
}