...
public class BiomeDecoratorKapteynB extends BiomeDecoratorMP
{
    ...
    protected void genDecorations(BiomeGenBase biome)
    {
        ...
        for (int i = 0; i < 1; ++i)
        {
            ...
            {
                new WorldGenLiquidLakes(KapteynBBlocks.frozen_water, KapteynBBlocks.kapteyn_b_block, 2).generate(this.currentWorld, this.randomGenerator, this.field_180294_c.add(this.randomGenerator.nextInt(16) + 8, this.randomGenerator.nextInt(32 - 16) + 16, this.randomGenerator.nextInt(16) + 8));
            }
        }
    }
}