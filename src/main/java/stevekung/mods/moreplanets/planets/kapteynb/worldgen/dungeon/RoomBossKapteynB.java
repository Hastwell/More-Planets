...
public class RoomBossKapteynB extends DungeonRoom
{
    ...
    public RoomBossKapteynB(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomBossKapteynB(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        this.worldObj.setBlock(this.spawnerCoords.posX, this.spawnerCoords.posY, this.spawnerCoords.posZ, KapteynBBlocks.kapteyn_b_block, 15, 3);
        ...
        {
            final TileEntityDungeonSpawner spawner = new TileEntityKapteynBDungeonSpawner();
