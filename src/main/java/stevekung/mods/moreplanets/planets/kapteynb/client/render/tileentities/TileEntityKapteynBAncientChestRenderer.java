...
public class TileEntityKapteynBAncientChestRenderer extends TileEntitySpecialRenderer<TileEntityKapteynBAncientChest>
{
    ...
    @Override
    public void renderTileEntityAt(TileEntityKapteynBAncientChest tile, double x, double y, double z, float partialTicks, int destroyStage)
    {
        int meta;
        ...
        else
        {
            ...
            {
                ((BlockKapteynBAncientChest)block).checkForSurroundingChests(tile.getWorld(), tile.getPos(), tile.getWorld().getBlockState(tile.getPos()));
                meta = tile.getBlockMetadata();
            }
