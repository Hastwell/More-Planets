...
public class ItemRendererTier8Rocket implements IItemRenderer
{
    ...
    protected ResourceLocation texture = new ResourceLocation("kapteynb:textures/model/tier8_rocket.png");
    ...
    public void transform(ItemStack itemstack, ItemRenderType type)
    {
        ...
        if (type == ItemRenderType.EQUIPPED)
        {
            ...
            if (player != null && player.ridingEntity != null && player.ridingEntity instanceof EntityTier8Rocket)
            {
