...
public class BlockKapteynBRedstoneOre extends BlockBaseMP implements IDetectableResource
{
	private boolean isOn;

	public BlockKapteynBRedstoneOre(String name, boolean isOn)
	{
		super(Material.rock);
	...
	private void activate(World world, BlockPos pos)
	{
		...
		if (this == KapteynBBlocks.kapteyn_b_redstone_ore)
		{
			world.setBlockState(pos, KapteynBBlocks.kapteyn_b_redstone_ore_active.getDefaultState());
		}
	}
	...
	{
		if (this == KapteynBBlocks.kapteyn_b_redstone_ore_active)
		{
			world.setBlockState(pos, KapteynBBlocks.kapteyn_b_redstone_ore.getDefaultState());
		}
	}
	...
	{
		return new ItemStack(KapteynBBlocks.kapteyn_b_redstone_ore);
	}
