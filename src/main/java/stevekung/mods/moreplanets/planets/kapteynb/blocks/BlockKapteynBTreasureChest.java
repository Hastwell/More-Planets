...
public class BlockKapteynBTreasureChest extends BlockTreasureChestMP
{
    public BlockKapteynBTreasureChest(String name)
    {
        super();
    ...
    public IInventory getContainer(World world, BlockPos pos)
    {
        ...
        if (!(tileentity instanceof TileEntityKapteynBTreasureChest))
        {
            return null;
        }
        else
