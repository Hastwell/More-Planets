...
package stevekung.mods.moreplanets.planets.kapteynb.dimension.sky;
...
{
    private ResourceLocation kapteynStarTexture = new ResourceLocation("kapteynb:textures/gui/celestialbodies/kapteyn_star.png");
    private ResourceLocation satelliteTexture = new ResourceLocation("kapteynb:textures/gui/celestialbodies/satellite.png");
