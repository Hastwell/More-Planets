...
public class EntityIceCrystalMeteorChunk extends Entity implements IProjectile
{
    ...
    public EntityIceCrystalMeteorChunk(World world, EntityLivingBase shootingEntity, EntityLivingBase target, float speed, float randMod)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityIceCrystalMeteorChunk(World par1World, EntityLivingBase par2EntityLivingBase, float speed)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
