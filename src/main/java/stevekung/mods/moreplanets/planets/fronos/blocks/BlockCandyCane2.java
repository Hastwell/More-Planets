...
public class BlockCandyCane2 extends BlockLogMP
{
    ...
    public BlockCandyCane2(String name)
    {
        ...
        this.setDefaultState(this.getDefaultState().withProperty(VARIANT, BlockType.light_blue_candy_cane).withProperty(BlockStateHelper.AXIS, EnumAxis.Y));
