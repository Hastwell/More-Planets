...
public class ComponentFronosVillageField2 extends ComponentFronosVillage
{
    ...
    public ComponentFronosVillageField2(ComponentFronosVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
        ...
        this.cropTypeE = this.getCorn(par3Random);
    }
    ...
    private Block getCorn(Random par1Random)
    {
        return FronosBlocks.glass_gem_corn1;
    }

    @SuppressWarnings("rawtypes")
    public static ComponentFronosVillageField2 func_74900_a(ComponentFronosVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new ComponentFronosVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 2, 0, 7, FronosBlocks.fronos_farmland, FronosBlocks.fronos_farmland, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 0, 1, 5, 0, 7, FronosBlocks.fronos_farmland, FronosBlocks.fronos_farmland, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 7, 0, 1, 8, 0, 7, FronosBlocks.fronos_farmland, FronosBlocks.fronos_farmland, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 10, 0, 1, 11, 0, 7, FronosBlocks.fronos_farmland, FronosBlocks.fronos_farmland, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 0, 0, 0, 0, 0, 8, FronosBlocks.fronos_log, FronosBlocks.fronos_log, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 6, 0, 0, 6, 0, 8, FronosBlocks.fronos_log, FronosBlocks.fronos_log, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 12, 0, 0, 12, 0, 8, FronosBlocks.fronos_log, FronosBlocks.fronos_log, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 0, 11, 0, 0, FronosBlocks.fronos_log, FronosBlocks.fronos_log, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 8, 11, 0, 8, FronosBlocks.fronos_log, FronosBlocks.fronos_log, false);
        ...
        for (i = 1; i <= 7; ++i)
        {
            ...
            this.placeBlockAtCurrentPosition(par1World, this.cropTypeE, 0, 11, 1, i, par3StructureBoundingBox);
        }
        ...
        for (i = 0; i < 9; ++i)
        {
            for (int j = 0; j < 13; ++j)
            {
                ...
                this.func_151554_b(par1World, FronosBlocks.fronos_dirt, 0, j, -1, i, par3StructureBoundingBox);
            }
        }
        return true;
    }
