...
public class ItemBlockVanillaCreamLayer extends ItemBlockMorePlanet
{
    public ItemBlockVanillaCreamLayer(Block block)
    {
        super(block);
    }
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (block == FronosBlocks.vanilla_cream_layer)
            {
