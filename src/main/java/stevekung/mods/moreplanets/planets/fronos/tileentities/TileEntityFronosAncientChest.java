...
public class TileEntityFronosAncientChest extends TileEntityAncientChestMP
{
    ...
    protected TileEntityFronosAncientChest func_174911_a(EnumFacing side)
    {
        ...
        if (this.func_174912_b(blockpos))
        {
            ...
            {
                TileEntityFronosAncientChest tileentitychest = (TileEntityFronosAncientChest)tileentity;
    ...
    private void func_174910_a(TileEntityFronosAncientChest chest, EnumFacing side)
    {
        if (chest.isInvalid())
        {
