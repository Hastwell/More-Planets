...
public class RoomChestsFronos extends DungeonRoom
{
	...
	public RoomChestsFronos(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomChestsFronos(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), FronosBlocks.fronos_ancient_chest.getDefaultState(), 2);
			TileEntityFronosAncientChest chest = (TileEntityFronosAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
