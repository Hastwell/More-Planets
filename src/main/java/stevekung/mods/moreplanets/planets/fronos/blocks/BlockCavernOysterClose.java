...
public class BlockCavernOysterClose extends BlockBaseMP implements ITileEntityProvider
{
    ...
    public void updateTick(World world, int x, int y, int z, Random rand)
    {
        ...
        if (!world.isRemote)
        {
            if (world.getBlockLightValue(x, y + 1, z) <= 5)
            {
                ...
                {
                    world.setBlock(x, y, z, FronosBlocks.cavern_oyster_open, world.getBlockMetadata(x, y, z), 3);
                }
            }
        }
    }
