...
public class BlockGoldenGrass extends BlockGrassMP implements IFronosGrass
{
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.fronosGrassIcon[1] = par1IconRegister.registerIcon("fronos:golden_grass_top");
        this.fronosGrassIcon[2] = par1IconRegister.registerIcon("fronos:golden_grass_side");
        this.fronosGrassIcon[3] = par1IconRegister.registerIcon("fronos:golden_grass_side");
        this.fronosGrassIcon[4] = par1IconRegister.registerIcon("fronos:golden_grass_side");
        this.fronosGrassIcon[5] = par1IconRegister.registerIcon("fronos:golden_grass_side");
        this.fronosGrassIcon[6] = par1IconRegister.registerIcon("fronos:golden_grass_side_tea");
    }
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random)
    {
        ...
        {
            MorePlanetsCore.proxy.spawnParticle("goldDust", x + random.nextFloat(), y + 1.3F, z + random.nextFloat());
        }
    }
    ...
    public IIcon getIcon(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            return block != FronosBlocks.tea_cream_layer ? this.fronosGrassIcon[2] : this.fronosGrassIcon[6];
        }
            ...
            else if (world.getBlockLightValue(par2, par3 + 1, par4) >= 9)
            {
                for (int var6 = 0; var6 < 4; ++var6)
                {
                    ...
                    if (world.getBlock(var7, var8, var9) == FronosBlocks.fronos_dirt && world.getBlockMetadata(var7, var8, var9) == 0)
                    {
                        ...
                        {
                            world.setBlock(var7, var8, var9, this);
                        }
                    }
                }
            }
