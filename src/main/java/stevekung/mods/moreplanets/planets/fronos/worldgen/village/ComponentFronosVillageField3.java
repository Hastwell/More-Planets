...
public class ComponentFronosVillageField3 extends ComponentFronosVillage
{
    ...
    public ComponentFronosVillageField3(ComponentFronosVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    private Block getRandomCrop(Random par1Random)
    {
        ...
        {
        default:
            return FronosBlocks.golden_crops;
        }
    }

    @SuppressWarnings("rawtypes")
    public static ComponentFronosVillageField3 func_74900_a(ComponentFronosVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new ComponentFronosVillageField3(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
