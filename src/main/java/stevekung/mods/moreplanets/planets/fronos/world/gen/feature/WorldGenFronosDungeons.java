                ...
                for (i2 = 3; i2 >= -1; --i2)
                {
                    for (j2 = i1; j2 <= j1; ++j2)
                    {
                        ...
                        else if (world.getBlockState(blockpos1).getBlock().getMaterial().isSolid() && world.getBlockState(blockpos1).getBlock() != FronosBlocks.fronos_ancient_chest)
                        {
                            ...
                            {
                                world.setBlockState(blockpos1, MPBlocks.space_mossy_cobblestone.getDefaultState().withProperty(BlockSpaceMossyCobblestone.VARIANT, BlockSpaceMossyCobblestone.BlockType.mossy_fronos_cobblestone), 2);
                            }
                            else
                            {
                ...
                while (true)
                {
                    if (i2 < 3)
                    {
                        ...
                        if (world.isAirBlock(blockpos2))
                        {
                            ...
                            if (k2 == 1)
                            {
                                world.setBlockState(blockpos2, ((BlockAncientChestMP)FronosBlocks.fronos_ancient_chest).correctFacing(world, blockpos2, FronosBlocks.fronos_ancient_chest.getDefaultState()), 2);
