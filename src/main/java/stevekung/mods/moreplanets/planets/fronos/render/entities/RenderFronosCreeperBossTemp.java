...
public class RenderFronosCreeperBossTemp extends RenderLiving
{
	...
	public RenderFronosCreeperBossTemp()
	{
	...
	{
		return RenderFronosCreeperBossTemp.creeperTexture;
	}
	...
	{
		return this.func_27006_a((EntityFronosCreeperBossTemp) par1EntityLivingBase, par2, par3);
	}
