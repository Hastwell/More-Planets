...
public class BiomeDecoratorFronos extends BiomeDecorator
{
	...
	protected void genDecorations(BiomeGenBase biome)
	{
		...
		for (i = 0; this.getGen(EventType.SAND) && i < this.normalSandPerChunk; ++i)
		{
			x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
			z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
			new WorldGenFronosSand(Blocks.sand.getDefaultState(), 6).generate(this.currentWorld, this.randomGenerator, x, this.currentWorld.getTopSolidOrLiquidBlock(x, z), z);
		}
		for (i = 0; this.getGen(EventType.SAND) && i < this.fronosSandPerChunk; ++i)
		{
			x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
			z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
			new WorldGenFronosSand(FronosBlocks.fronos_sand.getDefaultState(), 4).generate(this.currentWorld, this.randomGenerator, x, this.currentWorld.getTopSolidOrLiquidBlock(x, z), z);
		}
		for (i = 0; this.getGen(EventType.SAND) && i < this.whiteSandPerChunk; ++i)
		{
			x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
			z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
			new WorldGenFronosSand(FronosBlocks.fronos_sand.getDefaultState().withProperty(BlockFronosSand.VARIANT, BlockFronosSand.BlockType.white_sand), 6).generate(this.currentWorld, this.randomGenerator, x, this.currentWorld.getTopSolidOrLiquidBlock(x, z), z);
		}
		for (i = 0; this.getGen(EventType.SAND) && i < this.cheeseSandPerChunk; ++i)
		{
			x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
			z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
			new WorldGenFronosSand(FronosBlocks.fronos_sand.getDefaultState().withProperty(BlockFronosSand.VARIANT, BlockFronosSand.BlockType.cheese_sand), 4).generate(this.currentWorld, this.randomGenerator, x, this.currentWorld.getTopSolidOrLiquidBlock(x, z), z);
		}
		for (i = 0; this.getGen(EventType.SAND) && i < this.gravelPerChunk; ++i)
		{
			x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
			z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
			new WorldGenFronosSand(Blocks.gravel.getDefaultState(), 6).generate(this.currentWorld, this.randomGenerator, x, this.currentWorld.getTopSolidOrLiquidBlock(x, z), z);
		}
		...
		for (i = 0; this.getGen(EventType.FLOWERS) && i < this.dandelionPerChunk; ++i)
		{
			if (this.randomGenerator.nextInt(4) == 0)
			{
				...
				z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				new WorldGenFronosFlowers(FronosBlocks.fronos_dandelion.getDefaultState()).generate(this.currentWorld, this.randomGenerator, x, y, z);
			}
			if (this.randomGenerator.nextInt(4) == 0)
			{
				x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
				y = this.randomGenerator.nextInt(256);
				z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				new WorldGenFronosFlowers(FronosBlocks.fronos_dandelion, 1).generate(this.currentWorld, this.randomGenerator, x, y, z);
			}
			if (this.randomGenerator.nextInt(4) == 0)
			{
				x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
				y = this.randomGenerator.nextInt(256);
				z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				new WorldGenFronosFlowers(FronosBlocks.fronos_dandelion, 2).generate(this.currentWorld, this.randomGenerator, x, y, z);
			}
			if (this.randomGenerator.nextInt(8) == 0)
			{
				x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
				y = this.randomGenerator.nextInt(256);
				z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				new WorldGenFronosFlowers(FronosBlocks.fronos_dandelion, 3).generate(this.currentWorld, this.randomGenerator, x, y, z);
			}
			if (this.randomGenerator.nextInt(8) == 0)
			{
				x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
				y = this.randomGenerator.nextInt(256);
				z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				new WorldGenFronosFlowers(FronosBlocks.fronos_dandelion, 4).generate(this.currentWorld, this.randomGenerator, x, y, z);
			}
			if (this.randomGenerator.nextInt(8) == 0)
			{
				x = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
				y = this.randomGenerator.nextInt(256);
				z = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				new WorldGenFronosFlowers(FronosBlocks.fronos_dandelion, 5).generate(this.currentWorld, this.randomGenerator, x, y, z);
			}
		}
