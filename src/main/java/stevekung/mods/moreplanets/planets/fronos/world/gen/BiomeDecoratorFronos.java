...
public class BiomeDecoratorFronos extends BiomeDecoratorMP
{
    ...
    protected void genDecorations(BiomeGenBase biome)
    {
        ...
        for (i = 0; i < chance; ++i)
        {
            ...
            WorldGenTreeMP tree = new WorldGenTreeMP(FronosBlocks.fronos_log, FronosBlocks.fronos_leaves, 1, 0, FronosBlocks.fronos_sapling, FronosBlocks.red_maple_ivy, this.currentWorld.getBlockState(this.field_180294_c.down()).getBlock() instanceof ICustomBlockProperty && ((ICustomBlockProperty)this.currentWorld.getBlockState(this.field_180294_c.down()).getBlock()).getProperty() == 0, FronosBlocks.fronos_dirt, null);
            tree.func_175904_e();
        ...
        for (i = 0; i < chance; ++i)
        {
            ...
            z = this.randomGenerator.nextInt(16) + 8;
            pos = this.currentWorld.getHeight(this.field_180294_c.add(x, 0, z));
            WorldGenTreeMP tree = new WorldGenTreeMP(FronosBlocks.fronos_log, FronosBlocks.fronos_leaves, 1, 1, FronosBlocks.fronos_sapling, FronosBlocks.yellow_maple_ivy, this.currentWorld.getBlockState(this.field_180294_c.down()).getBlock() instanceof ICustomBlockProperty && ((ICustomBlockProperty)this.currentWorld.getBlockState(this.field_180294_c.down()).getBlock()).getProperty() == 0, FronosBlocks.fronos_dirt, null);
            tree.func_175904_e();
            tree.generate(this.currentWorld, this.randomGenerator, pos);
        }
        ...
        for (i = 0; i < this.purpleMapleTreePerChunk; ++i)
        {
            ...
            z = this.randomGenerator.nextInt(16) + 8;
            pos = this.currentWorld.getHeight(this.field_180294_c.add(x, 0, z));
            WorldGenTreeMP tree = new WorldGenTreeMP(FronosBlocks.fronos_log, FronosBlocks.fronos_leaves, 1, 2, FronosBlocks.fronos_sapling, FronosBlocks.purple_maple_ivy, this.currentWorld.getBlockState(this.field_180294_c.down()).getBlock() instanceof ICustomBlockProperty && ((ICustomBlockProperty)this.currentWorld.getBlockState(this.field_180294_c.down()).getBlock()).getProperty() == 0, FronosBlocks.fronos_dirt, null);
            tree.func_175904_e();
            tree.generate(this.currentWorld, this.randomGenerator, pos);
        }
        ...
        while (i < this.waterlilyPerChunk)
        {
            x = this.randomGenerator.nextInt(16) + 8;
            z = this.randomGenerator.nextInt(16) + 8;
            int i1 = this.nextInt(this.currentWorld.getHeight(this.field_180294_c.add(x, 0, z)).getY() * 2);
