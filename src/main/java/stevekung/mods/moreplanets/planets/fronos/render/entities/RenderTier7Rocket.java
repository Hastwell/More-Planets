...
public class RenderTier7Rocket extends Render
{
    ...
    public void renderSpaceship(EntityTier7Rocket entity, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderSpaceship((EntityTier7Rocket) par1Entity, par2, par4, par6, par8, par9);
    }
}