...
public class BlockCandyExtractor extends BlockContainerMP
{
    ...
    {
        return !this.isActive ? MorePlanetsCore.mpBlocksTab : null;
    }
    ...
    public static void setState(boolean active, World world, BlockPos pos)
    {
        ...
        if (active)
        {
            world.setBlockState(pos, FronosBlocks.candy_extractor_active.getDefaultState().withProperty(BlockStateHelper.FACING, state.getValue(BlockStateHelper.FACING)), 3);
            world.setBlockState(pos, FronosBlocks.candy_extractor_active.getDefaultState().withProperty(BlockStateHelper.FACING, state.getValue(BlockStateHelper.FACING)), 3);
        }
        else
        {
            world.setBlockState(pos, FronosBlocks.candy_extractor_idle.getDefaultState().withProperty(BlockStateHelper.FACING, state.getValue(BlockStateHelper.FACING)), 3);
            world.setBlockState(pos, FronosBlocks.candy_extractor_idle.getDefaultState().withProperty(BlockStateHelper.FACING, state.getValue(BlockStateHelper.FACING)), 3);
        }
    ...
    public void randomDisplayTick(World world, BlockPos pos, IBlockState state, Random rand)
    {
        if (this.isActive)
        {
            ...
            case 1:
                ...
                MorePlanetsCore.proxy.spawnParticle(EnumParticleTypesMP.BLUE_FLAME, d0 - d3, d1, d2 + d4);
                break;
            case 2:
                world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0 + d3, d1, d2 + d4, 0.0D, 0.0D, 0.0D, new int[0]);
                MorePlanetsCore.proxy.spawnParticle(EnumParticleTypesMP.BLUE_FLAME, d0 + d3, d1, d2 + d4);
            ...
            case 3:
                ...
                MorePlanetsCore.proxy.spawnParticle(EnumParticleTypesMP.BLUE_FLAME, d0 + d4, d1, d2 - d3);
                break;
            case 4:
                world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0 + d4, d1, d2 + d3, 0.0D, 0.0D, 0.0D, new int[0]);
                MorePlanetsCore.proxy.spawnParticle(EnumParticleTypesMP.BLUE_FLAME, d0 + d4, d1, d2 + d3);
