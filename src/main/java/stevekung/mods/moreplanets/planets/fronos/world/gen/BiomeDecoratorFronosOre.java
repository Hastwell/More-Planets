...
public class BiomeDecoratorFronosOre extends BiomeDecoratorMP
{
    ...
    public BiomeDecoratorFronosOre()
    {
        ...
        this.goldGen = new WorldGenMinableMeta(FronosBlocks.fronos_block1, 8, 0, true, FronosBlocks.fronos_block, 0);
        this.diamondGen = new WorldGenMinableMeta(FronosBlocks.fronos_block1, 7, 1, true, FronosBlocks.fronos_block, 0);
        this.emeraldGen = new WorldGenMinableMeta(FronosBlocks.fronos_block1, 1, 2, true, FronosBlocks.fronos_block, 0);
        this.siliconGen = new WorldGenMinableMeta(FronosBlocks.fronos_block1, 7, 3, true, FronosBlocks.fronos_block, 0);
