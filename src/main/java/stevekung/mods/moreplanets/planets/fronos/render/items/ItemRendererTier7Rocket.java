...
{
    protected static ResourceLocation chestTexture = new ResourceLocation("textures/entity/chest/normal.png");
    ...
    protected ResourceLocation texture = new ResourceLocation("fronos:textures/model/tier7_rocket.png");
    ...
    protected void renderSpaceship(ItemRenderType type, RenderBlocks render, ItemStack item)
    {
        GL11.glPushMatrix();
        ...
        if (type == ItemRenderType.INVENTORY)
        {
            ...
            if (EnumRocketType.values()[index].getInventorySpace() > 3)
            {
                ...
                FMLClientHandler.instance().getClient().renderEngine.bindTexture(ItemRendererTier7Rocket.chestTexture);
                GL11.glPushMatrix();
    ...
    public void transform(ItemStack itemstack, ItemRenderType type)
    {
        ...
        if (type == ItemRenderType.EQUIPPED)
        {
            ...
            if (player != null && player.ridingEntity != null && player.ridingEntity instanceof EntityTier7Rocket)
            {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        {
        case EQUIPPED:
            this.renderSpaceship(type, (RenderBlocks) data[0], item);
            break;
        case EQUIPPED_FIRST_PERSON:
            this.renderSpaceship(type, (RenderBlocks) data[0], item);
            break;
