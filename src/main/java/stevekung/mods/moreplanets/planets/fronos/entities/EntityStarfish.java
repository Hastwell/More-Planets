...
public class EntityStarfish extends EntityAnimal
{
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return state.getBlock() instanceof ICustomBlockProperty && ((ICustomBlockProperty)this.worldObj.getBlockState(this.getPosition().down()).getBlock()).getProperty() == 0 || state == FronosBlocks.fronos_sand.getDefaultState().withProperty(BlockFronosSand.VARIANT, BlockFronosSand.BlockType.white_sand) || state == Blocks.sand.getDefaultState();
    }
