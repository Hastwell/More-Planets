...
{
    private static final ResourceLocation tier7SchematicTexture = new ResourceLocation("fronos:textures/gui/schematic_tier7_rocket.png");
    private int pageIndex;

    public GuiSchematicTier7Rocket(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new ContainerSchematicTier7Rocket(par1InventoryPlayer, x, y, z));
        this.ySize = 238;
    }
    ...
    {
        this.fontRendererObj.drawString(GCCoreUtil.translate("schematics.container.rocket.tier7"), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(GuiSchematicTier7Rocket.tier7SchematicTexture);
