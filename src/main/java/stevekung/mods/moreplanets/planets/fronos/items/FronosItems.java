...
public class FronosItems
{
    ...
    public static void init()
    {
        ...
        FronosItems.fronos_dungeon_key = new ItemDungeonKeyMP("fronos_dungeon_key", 7);
        ...
        FronosItems.tier_7_rocket_schematic = new ItemInformation("tier_7_rocket_schematic", new VariantsName(new ItemDescription()
        {
            @Override
        ...
        FronosItems.tier_8_rocket_module = new ItemMultiVariantInfo("tier_8_rocket_module", new VariantsName(new ItemDescription()
        {
            @Override
            public void addDescription(ItemStack itemStack, List list, boolean useLShift)
            {
        ...
        }, "tier_8_rocket_engine", "tier_8_booster", "tier_8_heavy_duty_plate"));
