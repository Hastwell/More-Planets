...
public class LayerJellySlimePetGel implements LayerRenderer<EntityJellySlimePet>
{
    ...
    @Override
    public void doRenderLayer(EntityJellySlimePet entity, float par2, float par3, float partialTicks, float par5, float par6, float par7, float scale)
    {
