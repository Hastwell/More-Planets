...
{
    private static final ResourceLocation oysterTexture = new ResourceLocation("fronos:textures/model/cup/mineral_water.png");
    public ModelFilledCup model = new ModelFilledCup();

    public void renderTileEntityChestAt(TileEntityMineralWaterCup oyster, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        this.bindTexture(TileEntityMineralWaterCupRenderer.oysterTexture);
    ...
    {
        this.renderTileEntityChestAt((TileEntityMineralWaterCup)par1TileEntity, par2, par4, par6, par8);
    }
}