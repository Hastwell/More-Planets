...
public class BlockPinkGrass extends BlockGrassMP implements ICustomBlockProperty
{
    public static PropertyBool HAS_CHOCOLATE_CREAM = PropertyBool.create("chocolate");

    public BlockPinkGrass(String name)
    {
        super();
        this.setUnlocalizedName(name);
        this.setDefaultState(this.getDefaultState().withProperty(HAS_CHOCOLATE_CREAM, false));
    }
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos)
    {
        ...
        return state.withProperty(HAS_CHOCOLATE_CREAM, Boolean.valueOf(block == FronosBlocks.chocolate_cream_layer));
    }
            ...
            else if (world.getLightFromNeighbors(pos.up()) >= 9)
            {
                for (int var6 = 0; var6 < 4; ++var6)
                {
                    ...
                    if (world.getBlockState(pos1) == FronosBlocks.fronos_dirt.getDefaultState())
                    {
                        ...
                        {
                            world.setBlockState(pos1, FronosBlocks.pink_grass.getDefaultState());
                        }
                    }
                }
            }
    ...
    {
        return new BlockState(this, new IProperty[] { HAS_CHOCOLATE_CREAM });
    }
