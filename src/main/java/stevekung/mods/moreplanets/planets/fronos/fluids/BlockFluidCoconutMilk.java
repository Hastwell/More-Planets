...
public class BlockFluidCoconutMilk extends BlockFluidBaseMP
{
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            MorePlanetsCore.proxy.spawnParticle("coconutMilk", par2 + par5Random.nextFloat(), par3 + 1, par4 + par5Random.nextFloat());
        }
        ...
        if (par5Random.nextInt(10) == 0 && World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4) && !par1World.getBlock(par2, par3 - 2, par4).getMaterial().blocksMovement())
        {
            ...
            MorePlanetsCore.proxy.spawnParticle("coconutMilkDrip", d5, d6, d7);
        }
    }
    ...
    {
        return "fronos:coconut_milk_still";
    }

    @Override
    public String getFlowingTextures()
    {
        return "fronos:coconut_milk_flowing";
    }
}