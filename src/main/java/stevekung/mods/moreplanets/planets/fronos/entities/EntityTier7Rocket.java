...
public class EntityTier7Rocket extends EntityTieredRocket
{
	...
	{
		return new ItemStack(FronosItems.tier_7_rocket, 1, this.rocketType.getIndex());
	}
	...
	public void onTeleport(EntityPlayerMP player)
	{
		...
		if (playerBase != null)
		{
			...
			stats.rocketItem = FronosItems.tier_7_rocket;
	...
	protected void spawnParticles(boolean launched)
	{
		if (!this.isDead)
		{
			...
			double y2 = this.prevPosY + (this.posY - this.prevPosY) + y1;
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		ItemStack rocket = new ItemStack(FronosItems.tier_7_rocket, 1, this.rocketType.getIndex());
