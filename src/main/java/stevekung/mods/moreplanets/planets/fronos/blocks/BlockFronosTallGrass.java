...
public class BlockFronosTallGrass extends BlockBushMP implements IShearable
{
    ...
    public List<ItemStack> onSheared(ItemStack itemStack, IBlockAccess world, BlockPos pos, int fortune)
    {
        ...
        list.add(new ItemStack(this, 1, this.getMetaFromState(world.getBlockState(pos))));
        return null;
    }
