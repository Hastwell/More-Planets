...
public class EntityCaramelDripFX extends EntityFX
{
    private Material materialType;
    private int bobTimer;

    public EntityCaramelDripFX(World par1World, double par2, double par4, double par6, Material par8Material)
    {
    ...
    public void onUpdate()
    {
        ...
        {
            double var2 = MathHelper.floor_double(this.posY) + 1 - BlockLiquid.getLiquidHeightPercent(this.worldObj.getBlockMetadata(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)));
