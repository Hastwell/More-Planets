...
public class BlockWhiteCakeBread extends BlockCakeMP
{
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.cakeBlockIcons[0] = par1IconRegister.registerIcon("fronos:white_cake_bottom");
        this.cakeBlockIcons[1] = par1IconRegister.registerIcon("fronos:white_cake_bottom");
        this.cakeBlockIcons[2] = par1IconRegister.registerIcon("fronos:white_cake_de_block_side");
        this.cakeBlockIcons[3] = par1IconRegister.registerIcon("fronos:white_cake_de_block_side");
    }
