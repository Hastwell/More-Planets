...
public class TileEntityCaramelCupRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityChestAt(TileEntityCaramelCup oyster, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        this.bindTexture(TileEntityCaramelCupRenderer.oysterTexture);
    ...
    {
        this.renderTileEntityChestAt((TileEntityCaramelCup)par1TileEntity, par2, par4, par6, par8);
    }
}