...
public class BlockFronosFarmland extends BlockBaseMP
{
    private IIcon wet;
    private IIcon dry;
    ...
    {
        return par1 == 1 ? par2 > 0 ? this.wet : this.dry : FronosBlocks.fronos_dirt.getBlockTextureFromSide(par1);
    }
    ...
    {
        this.wet = par1IconRegister.registerIcon("fronos:fronos_farmland_wet");
        this.dry = par1IconRegister.registerIcon("fronos:fronos_farmland_dry");
    }
