...
public class StructureFronosVillageStart extends StructureStart
{
    ...
    public StructureFronosVillageStart(World world, Random rand, int x, int z, int type)
    {
        super(x, z);

        ArrayList<StructureFronosVillagePieceWeight> var6 = StructureFronosVillagePieces.getStructureVillageWeightedPieceList(rand, type);
        ComponentFronosVillageStartPiece var7 = new ComponentFronosVillageStartPiece(world.getWorldChunkManager(), rand, (x << 4) + 2, (z << 4) + 2, var6, type);
