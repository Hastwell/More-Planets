...
public class ModelFilledCup extends ModelBase
{
    ...
    public ModelRenderer ovantine;

    public ModelFilledCup()
    {
        ...
        this.ovantine = new ModelRenderer(this, 32, 0);
        this.ovantine.addBox(0F, 0F, 0F, 4, 4, 4, 0F);
        this.ovantine.setRotationPoint(-2F, 19F, -2F);
    }
