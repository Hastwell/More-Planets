...
public class BlockPlainsGrass extends BlockGrassMP implements IFronosGrass
{
    ...
    public BlockPlainsGrass(String name)
    {
        super();
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.grassIcon[1] = par1IconRegister.registerIcon("fronos:plains_grass_top");
        this.grassIcon[2] = par1IconRegister.registerIcon("fronos:plains_grass_side");
        this.grassIcon[3] = par1IconRegister.registerIcon("fronos:plains_grass_side");
        this.grassIcon[4] = par1IconRegister.registerIcon("fronos:plains_grass_side");
        this.grassIcon[5] = par1IconRegister.registerIcon("fronos:plains_grass_side");
        this.grassIcon[6] = par1IconRegister.registerIcon("fronos:plains_grass_side_orange");
    }
    ...
    public IIcon getIcon(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            return block != FronosBlocks.orange_cream_layer ? this.grassIcon[2] : this.grassIcon[6];
        }
            ...
            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
            {
                for (int var6 = 0; var6 < 4; ++var6)
                {
                    ...
                    if (par1World.getBlock(var7, var8, var9) == FronosBlocks.fronos_dirt && par1World.getBlockMetadata(var7, var8, var9) == 0 && par1World.getBlockLightValue(var7, var8 + 1, var9) >= 4 && par1World.getBlockLightOpacity(par2, par3 + 1, par4) <= 2)
                    {
                        ...
                        {
                            par1World.setBlock(var7, var8, var9, FronosBlocks.plains_grass);
                        }
                    }
                }
            }
