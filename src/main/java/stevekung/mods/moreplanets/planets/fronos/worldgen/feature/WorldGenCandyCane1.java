...
public class WorldGenCandyCane1 extends WorldGenerator
{
    ...
    public boolean generate(World world, Random rand, int x, int y, int z)
    {
        ...
        else
        {
            ...
            world.setBlock(x, y + 1, z, FronosBlocks.candy_cane1, 0, 2);
            world.setBlock(x, y + 2, z, FronosBlocks.candy_cane1, 0, 2);
            world.setBlock(x, y + 3, z, FronosBlocks.candy_cane1, 1, 2);
            world.setBlock(x, y + 4, z, FronosBlocks.candy_cane1, 1, 2);
            world.setBlock(x, y + 5, z, FronosBlocks.candy_cane1, 2, 2);
            world.setBlock(x, y + 6, z, FronosBlocks.candy_cane1, 2, 2);
            world.setBlock(x, y + 7, z, FronosBlocks.candy_cane1, 3, 2);
            world.setBlock(x, y + 8, z, FronosBlocks.candy_cane1, 3, 2);
