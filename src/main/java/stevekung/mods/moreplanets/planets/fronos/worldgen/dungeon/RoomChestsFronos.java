...
public class RoomChestsFronos extends DungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public RoomChestsFronos(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    public void generate(Block[] chunk, byte[] meta, int cx, int cz)
    {
        ...
        if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, FronosBlocks.fronos_ancient_chest, 0))
        {
    ...
    {
        return new RoomChestsFronos(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        {
            this.worldObj.setBlock(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ, FronosBlocks.fronos_ancient_chest, 0, 2);
            final TileEntityFronosAncientChest chest = (TileEntityFronosAncientChest) this.worldObj.getTileEntity(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ);
