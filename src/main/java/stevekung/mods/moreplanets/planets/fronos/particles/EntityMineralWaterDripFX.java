...
public class EntityMineralWaterDripFX extends EntityFX
{
    private final Material materialType;
    private int bobTimer;

    public EntityMineralWaterDripFX(World par1World, double par2, double par4, double par6, Material par8Material)
    {
    ...
    public void onUpdate()
    {
        ...
        {
            this.particleGreen = 0.7F / (40 - this.bobTimer + 16);
            this.particleBlue = 0.8F / (40 - this.bobTimer + 8);
            this.particleRed = 0.4F;
            this.particleAlpha = 0.6F;
        }
