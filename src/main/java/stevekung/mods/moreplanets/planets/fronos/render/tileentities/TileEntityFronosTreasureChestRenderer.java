...
{
    private static final ResourceLocation treasureChestTexture = new ResourceLocation("fronos:textures/model/fronos_treasure_chest.png");

    private final ModelTreasureChest chestModel = new ModelTreasureChest();

    public void renderTileEntityTreasureChestAt(TileEntityFronosTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        this.bindTexture(TileEntityFronosTreasureChestRenderer.treasureChestTexture);
    ...
    {
        this.renderTileEntityTreasureChestAt((TileEntityFronosTreasureChest) par1TileEntity, par2, par4, par6, par8);
    }
}