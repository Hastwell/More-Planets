...
public class BlockFronosLog extends BlockLogMP
{
    public static PropertyEnum VARIANT = PropertyEnum.create("variant", BlockType.class);

    public BlockFronosLog(String name)
    {
        super();
        this.setDefaultState(this.getDefaultState().withProperty(VARIANT, BlockType.coconut_wood_log).withProperty(BlockStateHelper.AXIS, EnumAxis.Y));
    ...
    {
        coconut_wood_log(0, "coconut_wood"),
        maple_wood_log(1, "maple_wood");
