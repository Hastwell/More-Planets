...
public class EntityCoconutMilkDripFX extends EntityFX
{
    private final Material materialType;
    private int bobTimer;

    public EntityCoconutMilkDripFX(World par1World, double par2, double par4, double par6, Material par8Material)
    {
    ...
    public void onUpdate()
    {
        ...
        {
            this.particleGreen = 1.0F / (40 - this.bobTimer + 16);
            this.particleBlue = 1.0F / (40 - this.bobTimer + 8);
            this.particleRed = 1.0F;
        }
