...
public abstract class ComponentFronosVillage extends StructureComponent
{
	...
	protected StructureComponent getNextComponentNN(ComponentFronosVillageStartPiece component, List list, Random rand, int par4, int par5)
	{
		if (this.coordBaseMode != null)
		{
			...
			{
			case 0:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.minX - 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, EnumFacing.WEST, this.getComponentType());
			case 1:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			case 2:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.minX - 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, EnumFacing.WEST, this.getComponentType());
			case 3:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	protected StructureComponent getNextComponentPP(ComponentFronosVillageStartPiece component, List list, Random rand, int par4, int par5)
	{
		if (this.coordBaseMode != null)
		{
			switch (SwitchEnumFacing.field_176064_a[this.coordBaseMode.ordinal()])
			{
			case 1:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, EnumFacing.EAST, this.getComponentType());
			case 2:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			case 3:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + par4, this.boundingBox.minZ + par5, EnumFacing.EAST, this.getComponentType());
			case 4:
				return StructureFronosVillagePieces.getNextStructureComponent(component, list, rand, this.boundingBox.minX + par5, this.boundingBox.minY + par4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
	...
	protected void spawnVillagers(World world, StructureBoundingBox box, int x, int y, int z, int par6)
	{
		if (this.villagersSpawned < par6)
		{
			for (int i1 = this.villagersSpawned; i1 < par6; ++i1)
			{
				...
				EntityFronosVillager entityvillager = new EntityFronosVillager(world);
