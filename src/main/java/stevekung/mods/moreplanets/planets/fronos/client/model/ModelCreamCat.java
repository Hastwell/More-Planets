...
public class ModelCreamCat extends ModelBase
{
    ...
    public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        if (this.isChild)
        {
            ...
            GlStateManager.translate(0.0F, 10.0F * par7, 4.0F * par7);
    ...
    {
        EntityCreamCat entityocelot = (EntityCreamCat)par1EntityLivingBase;
