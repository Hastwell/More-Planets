...
public class BlockT5PolongniusTreasureChest extends BlockTreasureChestMP
{
    public BlockT5PolongniusTreasureChest(String name)
    {
        super();
    ...
    {
        TileEntityPolongniusTreasureChest var7 = (TileEntityPolongniusTreasureChest) par1World.getTileEntity(par2, par3, par4);
    ...
    {
        return "polongnius:polongnius_treasure_chest";
    }
