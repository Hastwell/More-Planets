...
public class TileEntityPolongniusTreasureChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation treasureChestTexture = new ResourceLocation("polongnius:textures/model/polongnius_treasure_chest.png");

    private final ModelTreasureChest chestModel = new ModelTreasureChest();

    public void renderGCTileEntityTreasureChestAt(TileEntityPolongniusTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        this.bindTexture(TileEntityPolongniusTreasureChestRenderer.treasureChestTexture);
    ...
    {
        this.renderGCTileEntityTreasureChestAt((TileEntityPolongniusTreasureChest) par1TileEntity, par2, par4, par6, par8);
    }
}