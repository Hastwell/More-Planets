...
package stevekung.mods.moreplanets.planets.polongnius.dimension.sky;
...
public class SkyProviderPolongnius extends IRenderHandler
{
    ...
    private ResourceLocation dionaTexture = new ResourceLocation("diona:textures/gui/celestialbodies/diona.png");
    private ResourceLocation nibiruTexture = new ResourceLocation("nibiru:textures/gui/celestialbodies/nibiru.png");
