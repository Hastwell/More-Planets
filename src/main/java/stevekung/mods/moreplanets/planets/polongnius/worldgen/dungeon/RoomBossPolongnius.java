...
public class RoomBossPolongnius extends DungeonRoom
{
    ...
    public RoomBossPolongnius(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomBossPolongnius(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        this.worldObj.setBlock(this.spawnerCoords.posX, this.spawnerCoords.posY, this.spawnerCoords.posZ, PolongniusBlocks.polongnius_block, 15, 3);
        ...
        {
            final TileEntityDungeonSpawner spawner = new TileEntityPolongniusDungeonSpawner();
