...
public class TileEntityPolongniusAncientChest extends TileEntityAncientChestMP
{
    ...
    protected TileEntityPolongniusAncientChest func_174911_a(EnumFacing side)
    {
        ...
        if (this.func_174912_b(blockpos))
        {
            ...
            {
                TileEntityPolongniusAncientChest tileentitychest = (TileEntityPolongniusAncientChest)tileentity;
    ...
    private void func_174910_a(TileEntityPolongniusAncientChest chest, EnumFacing side)
    {
        if (chest.isInvalid())
        {
