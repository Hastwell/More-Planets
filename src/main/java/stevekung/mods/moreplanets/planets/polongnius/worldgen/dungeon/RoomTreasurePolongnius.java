...
public class RoomTreasurePolongnius extends DungeonRoom
{
    ...
    public RoomTreasurePolongnius(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    public ItemStack getGuaranteedLoot(Random rand)
    {
        ...
        case 1:
            return new ItemStack(PolongniusItems.polongnius_food, rand.nextInt(4) + 1, 0);
        }
        return null;
    }
    ...
    {
        return new RoomTreasurePolongnius(dungeon, x, y, z, dir);
    }
}