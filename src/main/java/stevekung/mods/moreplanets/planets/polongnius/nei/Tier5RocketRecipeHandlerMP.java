...
public class Tier5RocketRecipeHandlerMP extends RocketRecipeHandlerMP
{
	public String getRecipeId()
	{
		return "galacticraft.tier5.rocket";
	}

	public Set<Entry<ArrayList<PositionedStack>, PositionedStack>> getRecipes()
	{
		return NEITier5RocketConfig.getRocketBenchRecipes();
	}
	...
	{
		return "moreplanets:textures/gui/schematic/tier_5_rocket.png";
	}
}