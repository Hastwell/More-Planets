...
public class EntityPolongniusMeteorChunk extends Entity implements IProjectile
{
    ...
    public EntityPolongniusMeteorChunk(World world, EntityLivingBase shooter, EntityLivingBase projectile, float velocity, float inaccuracy)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityPolongniusMeteorChunk(World world, EntityLivingBase shooter, float velocity)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = shooter;
    ...
    public void onCollideWithPlayer(EntityPlayer player)
    {
        if (!this.worldObj.isRemote && this.inGround)
        {
            ...
            if (this.canBePickedUp == 1 && !player.inventory.addItemStackToInventory(new ItemStack(PolongniusItems.polongnius_meteor_chunk)))
            {
                flag = false;
            }
            if (flag)
