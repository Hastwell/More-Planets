...
package stevekung.mods.moreplanets.planets.polongnius.inventory.slot;
...
public class SlotSchematicTier5Rocket extends Slot
{
    private int index;
    private int x, y, z;
    private EntityPlayer player;

    public SlotSchematicTier5Rocket(IInventory par2IInventory, int par3, int par4, int par5, int x, int y, int z, EntityPlayer player)
    {
    ...
    public boolean isItemValid(ItemStack par1ItemStack)
    {
        ...
        case 11:
            return par1ItemStack.getItem() == DionaItems.diona_item && meta == 4 ? true : false;
        case 12:
            return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 6 ? true : false;
        case 13:
            return par1ItemStack.getItem() == AsteroidsItems.basicItem && meta == 2 ? true : false;
        case 14:
            return par1ItemStack.getItem() == AsteroidsItems.basicItem && meta == 2 ? true : false;
        case 15:
            return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 5 ? true : false;
        case 16:
            return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 6 ? true : false;
        case 17:
            return par1ItemStack.getItem() == AsteroidsItems.basicItem && meta == 2 ? true : false;
