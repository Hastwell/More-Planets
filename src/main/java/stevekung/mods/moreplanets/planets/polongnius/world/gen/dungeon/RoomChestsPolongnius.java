...
public class RoomChestsPolongnius extends DungeonRoom
{
	...
	public RoomChestsPolongnius(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	public void generate(ChunkPrimer chunk, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, hx, this.posY, hz, cx, cz, PolongniusBlocks.polongnius_ancient_chest, 0))
		{
	...
	{
		return new RoomChestsPolongnius(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), PolongniusBlocks.polongnius_ancient_chest.getDefaultState(), 2);
			TileEntityPolongniusAncientChest chest = (TileEntityPolongniusAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
