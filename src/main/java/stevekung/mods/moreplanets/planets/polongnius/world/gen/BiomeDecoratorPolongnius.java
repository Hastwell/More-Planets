    ...
    protected void genDecorations(BiomeGenBase biome)
    {
        ...
        for (i = 0; i < this.lavaLakePerChunk; ++i)
        {
            if (this.randomGenerator.nextInt(10) == 0)
            {
                ...
                new WorldGenLiquidLakes(PolongniusBlocks.cheese_of_milk, PolongniusBlocks.polongnius_block, 2).generate(this.currentWorld, this.randomGenerator, new BlockPos(x, y, z));
            }
        }
    }
}