...
public class TileEntityPolongniusAncientChestRenderer extends TileEntitySpecialRenderer
{
    ...
    private static ResourceLocation chestNormal = new ResourceLocation("polongnius:textures/model/polongnius_ancient_chest.png");
    private static ResourceLocation largeChestNormal = new ResourceLocation("polongnius:textures/model/polongnius_ancient_chest_double.png");
    ...
    public void renderTileEntityChestAt(TileEntityPolongniusAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockPolongniusAncientChest && i == 0)
            {
                try
                {
                    ((BlockPolongniusAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityPolongniusAncientChestRenderer.christmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityPolongniusAncientChestRenderer.steveChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityPolongniusAncientChestRenderer.chestNormal);
                }
            }
            else
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityPolongniusAncientChestRenderer.largeChristmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityPolongniusAncientChestRenderer.steveLargeChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityPolongniusAncientChestRenderer.largeChestNormal);
                }
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntityPolongniusAncientChest)par1TileEntity, par2, par4, par6, par8);
    }
}