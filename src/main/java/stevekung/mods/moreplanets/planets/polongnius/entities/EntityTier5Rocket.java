...
public class EntityTier5Rocket extends EntityTieredRocket
{
    ...
    {
        return new ItemStack(PolongniusItems.tier5_rocket, 1, this.rocketType.getIndex());
    }
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
    {
        ...
        ItemStack rocket = new ItemStack(PolongniusItems.tier5_rocket, 1, this.rocketType.getIndex());
