...
public class EntityTier5Rocket extends EntityTieredRocket
{
    ...
    public EntityTier5Rocket(World world, double x, double y, double z, EnumRocketType rocketType)
    {
        super(world, x, y, z);
    ...
    {
        return new ItemStack(PolongniusItems.tier_5_rocket, 1, this.rocketType.getIndex());
    }
    ...
    public void onTeleport(EntityPlayerMP player)
    {
        ...
        if (playerBase != null)
        {
            ...
            stats.rocketItem = PolongniusItems.tier_5_rocket;
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
    {
        ...
        ItemStack rocket = new ItemStack(PolongniusItems.tier_5_rocket, 1, this.rocketType.getIndex() + 10);
