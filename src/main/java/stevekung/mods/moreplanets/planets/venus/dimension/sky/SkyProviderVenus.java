...
{
	private static ResourceLocation overworldTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/celestialbodies/earth.png");
	...
	public SkyProviderVenus(IGalacticraftWorldProvider venusProvider)
	{
		this.sunSize = 17.5F * venusProvider.getSolarSize();
