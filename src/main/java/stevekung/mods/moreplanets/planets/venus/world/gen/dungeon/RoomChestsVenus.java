...
public class RoomChestsVenus extends DungeonRoom
{
	...
	public RoomChestsVenus(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomChestsVenus(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), VenusBlocks.venus_ancient_chest.getDefaultState(), 2);
			TileEntityVenusAncientChest chest = (TileEntityVenusAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
