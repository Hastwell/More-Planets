...
public class ComponentVenusVillageField extends ComponentVenusVillage
{
    ...
    public ComponentVenusVillageField(ComponentVenusVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentVenusVillageField func_74900_a(ComponentVenusVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 13, 4, 9, par6);
        return StructureComponent.findIntersecting(par1List, var8) == null ? new ComponentVenusVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
