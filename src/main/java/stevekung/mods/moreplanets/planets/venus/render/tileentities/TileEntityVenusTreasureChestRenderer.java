...
public class TileEntityVenusTreasureChestRenderer extends TileEntitySpecialRenderer
{
    private ResourceLocation treasureChestTexture = new ResourceLocation("venus:textures/model/venus_treasure_chest.png");
    private ModelTreasureChest chestModel = new ModelTreasureChest();

    public void renderGCTileEntityTreasureChestAt(TileEntityVenusTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        this.bindTexture(this.treasureChestTexture);
        GL11.glPushMatrix();
    ...
    {
        this.renderGCTileEntityTreasureChestAt((TileEntityVenusTreasureChest) par1TileEntity, par2, par4, par6, par8);
    }
}