...
public class ComponentVenusVillageField2 extends ComponentVenusVillage
{
    ...
    public ComponentVenusVillageField2() {}

    public ComponentVenusVillageField2(ComponentVenusVillageStartPiece component, int type, Random rand, StructureBoundingBox box, EnumFacing facing)
    {
    ...
    public static ComponentVenusVillageField2 func_74900_a(ComponentVenusVillageStartPiece component, List list, Random rand, int x, int y, int z, EnumFacing facing, int type)
    {
        StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 13, 4, 9, facing);
        return ComponentVenusVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(list, structureboundingbox) == null ? new ComponentVenusVillageField2(component, type, rand, structureboundingbox, facing) : null;
    }
    ...
    public boolean addComponentParts(World world, Random rand, StructureBoundingBox box)
    {
        ...
        this.fillWithBlocks(world, box, 7, 0, 1, 8, 0, 7, Blocks.farmland.getDefaultState(), Blocks.farmland.getDefaultState(), false);
        this.fillWithBlocks(world, box, 10, 0, 1, 11, 0, 7, Blocks.farmland.getDefaultState(), Blocks.farmland.getDefaultState(), false);
