...
public class RoomTreasureVenus extends DungeonRoom
{
	...
	public RoomTreasureVenus(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	public void generate(ChunkPrimer chunk, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, hx, this.posY, hz, cx, cz, VenusBlocks.venus_treasure_chest, 0))
		{
	...
	{
		return new RoomTreasureVenus(dungeon, x, y, z, facing);
	}
}