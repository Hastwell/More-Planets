...
public class ComponentVenusVillageWell extends ComponentVenusVillage
{
    ...
    public ComponentVenusVillageWell(ComponentVenusVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5)
    {
    ...
    {
        StructureVenusVillagePieces.getNextStructureComponentVillagePath((ComponentVenusVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
        StructureVenusVillagePieces.getNextStructureComponentVillagePath((ComponentVenusVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
        StructureVenusVillagePieces.getNextStructureComponentVillagePath((ComponentVenusVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
        StructureVenusVillagePieces.getNextStructureComponentVillagePath((ComponentVenusVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, VenusBlocks.venus_block, 12, Blocks.flowing_water, 0, false);
        ...
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, VenusBlocks.venus_block, 12, VenusBlocks.venus_block, 12, false);
        ...
        for (int var4 = 0; var4 <= 5; ++var4)
        {
            for (int var5 = 0; var5 <= 5; ++var5)
            {
                ...
                {
                    this.placeBlockAtCurrentPosition(par1World, VenusBlocks.venus_block, 12, var5, 11, var4, par3StructureBoundingBox);
