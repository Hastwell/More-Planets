...
public class ItemBlockVenusSandstoneSlab extends ItemBlockBaseMP
{
	private BlockVenusSandstoneSlab singleSlab;
	private BlockDoubleVenusSandstoneSlab doubleSlab;
