...
public class EntityVenusianBlaze extends EntityMob implements IEntityBreathable
{
    ...
    public EntityVenusianBlaze(World world)
    {
        super(world);
        this.isImmuneToFire = true;
        this.experienceValue = 10;
        this.tasks.addTask(4, new EntityVenusianBlaze.AIFireballAttack());
    ...
    {
        private EntityVenusianBlaze field_179469_a = EntityVenusianBlaze.this;
            ...
            else if (d0 < 256.0D)
            {
                ...
                if (this.field_179468_c <= 0)
                {
                    ...
                    if (this.field_179467_b > 1)
                    {
                        ...
                        for (int i = 0; i < 1; ++i)
                        {
                            EntitySmallFireball entitysmallfireball = new EntitySmallFireball(this.field_179469_a.worldObj, this.field_179469_a, d1 + this.field_179469_a.getRNG().nextGaussian() * f, d2, d3 + this.field_179469_a.getRNG().nextGaussian() * f);
