...
public class BlockVenusSandstoneSlab extends BlockSlab
{
	...
	public void registerBlockIcons(IIconRegister par1IconRegister)
	{
		...
		this.textures[0] = par1IconRegister.registerIcon("venus:venus_sandstone");
		this.textures[1] = par1IconRegister.registerIcon("venus:venus_sandstone_top");
		this.textures[2] = par1IconRegister.registerIcon("venus:venus_sandstone_bottom");
	}
	...
	public IIcon getIcon(int side, int meta)
	{
		...
		else if (this.category == VenusSlabCategory.WOOD1)
		{
			if (meta == 0 || meta == 8)
			{
				switch (side)
