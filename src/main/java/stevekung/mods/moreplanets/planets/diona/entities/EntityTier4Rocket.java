...
public class EntityTier4Rocket extends EntityTieredRocket
{
    ...
    {
        return new ItemStack(DionaItems.tier4_rocket, 1, this.rocketType.getIndex());
    }
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
    {
        ...
        ItemStack rocket = new ItemStack(DionaItems.tier4_rocket, 1, this.rocketType.getIndex());
