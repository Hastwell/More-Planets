...
public class GuiSchematicTier4Rocket extends GuiContainer implements ISchematicResultPage
{
    ...
    {
        super(new ContainerSchematicTier4Rocket(par1InventoryPlayer, x, y, z));
        this.ySize = 238;
    }
    ...
    {
        this.fontRendererObj.drawString(StatCollector.translateToLocal("schematics.container.rocket.tier4"), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(GuiSchematicTier4Rocket.tier4SchematicTexture);
