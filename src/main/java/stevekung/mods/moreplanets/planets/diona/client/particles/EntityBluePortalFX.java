...
package stevekung.mods.moreplanets.planets.diona.client.particles;
...
public class EntityBluePortalFX extends EntityFX
{
    ...
    public EntityBluePortalFX(World world, double x, double y, double z, double moX, double moY, double moZ)
    {
