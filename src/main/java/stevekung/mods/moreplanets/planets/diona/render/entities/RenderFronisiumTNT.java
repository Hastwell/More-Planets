...
public class RenderFronisiumTNT extends Render
{
    ...
    public RenderFronisiumTNT()
    {
        this.shadowSize = 0.5F;
    }

    public void doRender(EntityFronisiumTNT tnt, double x, double y, double z, float par5, float par6)
    {
        GL11.glPushMatrix();
        ...
        this.blockRenderer.renderBlockAsItem(DionaBlocks.fronisium_tnt, 0, tnt.getBrightness(par6));
        ...
        if (tnt.fuse / 5 % 2 == 0)
        {
            ...
            this.blockRenderer.renderBlockAsItem(DionaBlocks.fronisium_tnt, 0, 1.0F);
    ...
    protected ResourceLocation getEntityTexture(EntityFronisiumTNT tnt)
    {
    ...
    {
        return this.getEntityTexture((EntityFronisiumTNT)tnt);
    }

    @Override
    public void doRender(Entity entity, double x, double y, double z, float par5, float par6)
    {
        this.doRender((EntityFronisiumTNT)entity, x, y, z, par5, par6);
    }
}