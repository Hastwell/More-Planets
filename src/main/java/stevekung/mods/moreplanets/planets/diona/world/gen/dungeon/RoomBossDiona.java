...
public class RoomBossDiona extends DungeonRoom
{
	...
	public RoomBossDiona(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomBossDiona(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		this.worldObj.setBlockState(this.spawnerCoords, DionaBlocks.diona_block.getDefaultState(), 3);//TODO Boss Dungeon Spawner
