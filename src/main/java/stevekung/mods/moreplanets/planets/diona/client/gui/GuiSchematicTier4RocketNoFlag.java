...
{
	private ResourceLocation texture = new ResourceLocation("moreplanets:textures/gui/tier_4_rocket_schematic.png");
	...
	{
		this.fontRendererObj.drawString(StatCollector.translateToLocal("schematics.container.rocket.noflag.tier4"), 7, -20 + 27, 4210752);
