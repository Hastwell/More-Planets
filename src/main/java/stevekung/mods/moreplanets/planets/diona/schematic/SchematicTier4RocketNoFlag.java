...
import stevekung.mods.moreplanets.planets.diona.client.gui.GuiSchematicTier4RocketNoFlag;
...
public class SchematicTier4RocketNoFlag implements ISchematicPage
{
	...
	{
		return new ItemStack(DionaItems.tier_4_rocket_schematic, 1, 1);
	}
	...
	{
		return new GuiSchematicTier4RocketNoFlag(player.inventory, pos.getX(), pos.getY(), pos.getZ());
	}

	@Override
	public Container getResultContainer(EntityPlayer player, BlockPos pos)
	{
		return new ContainerSchematicTier4RocketNoFlag(player.inventory, pos.getX(), pos.getY(), pos.getZ());
	}
