...
{
	IBlockState topBlock = DionaBlocks.diona_block.getDefaultState();
	IBlockState fillBlock = DionaBlocks.diona_block.getDefaultState().withProperty(BlockDiona.VARIANT, BlockDiona.BlockType.diona_sub_surface_rock);
	IBlockState lowerBlock = DionaBlocks.diona_block.getDefaultState().withProperty(BlockDiona.VARIANT, BlockDiona.BlockType.diona_rock);
	...
	{
		this.dionaBiomeDecorator.decorate(world, rand, x, z);
	}
