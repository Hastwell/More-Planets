...
public class RenderDionaCreeperMinion extends RenderLiving
{
	...
	protected void func_180570_a(EntityDionaCreeperMinion entity, float par2)
	{
	...
	protected int func_180571_a(EntityDionaCreeperMinion entity, float par2)
	{
	...
	{
		this.func_180570_a((EntityDionaCreeperMinion)entity, par2);
	...
	{
		return this.func_180571_a((EntityDionaCreeperMinion)entity, par3);
	}
