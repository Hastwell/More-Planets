...
public class SlotSchematicTier4RocketNoFlag extends Slot
{
	...
	public boolean isItemValid(ItemStack par1ItemStack)
	{
		...
		case 2:
			return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 1 ? true : false;
		case 3:
			return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 1 ? true : false;
		case 4:
			return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 1 ? true : false;
		...
		case 11:
			return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 1 ? true : false;
		case 12:
			return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 3 ? true : false;
		case 13:
			return par1ItemStack.getItem() == AsteroidsItems.basicItem && meta == 2 ? true : false;
		case 14:
			return par1ItemStack.getItem() == AsteroidsItems.basicItem && meta == 2 ? true : false;
		case 15:
			return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 2 ? true : false;
		case 16:
			return par1ItemStack.getItem() == DionaItems.tier_4_rocket_module && meta == 3 ? true : false;
		case 17:
			return par1ItemStack.getItem() == AsteroidsItems.basicItem && meta == 2 ? true : false;
