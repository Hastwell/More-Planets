...
public class EntityTier4RocketNoFlag extends EntityTieredRocket
{
	...
	{
		return new ItemStack(DionaItems.tier_4_rocket, 1, this.rocketType.getIndex() + 10);
	}
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		ItemStack rocket = new ItemStack(DionaItems.tier_4_rocket, 1, this.rocketType.getIndex() + 10);
