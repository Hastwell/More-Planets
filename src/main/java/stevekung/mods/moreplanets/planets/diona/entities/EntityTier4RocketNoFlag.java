...
public class EntityTier4RocketNoFlag extends EntityTieredRocket
{
    public EntityTier4RocketNoFlag(World par1World)
    {
        super(par1World);
    ...
    public EntityTier4RocketNoFlag(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
    ...
    {
        return new ItemStack(DionaItems.tier4_rocket, 1, this.rocketType.getIndex() + 10);
    }
    ...
    public void onTeleport(EntityPlayerMP player)
    {
        ...
        if (playerBase != null)
        {
            ...
            stats.rocketItem = DionaItems.tier4_rocket;
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
    {
        ...
        ItemStack rocket = new ItemStack(DionaItems.tier4_rocket, 1, this.rocketType.getIndex() + 10);
