...
public class CraftingRecipesDiona
{
	...
	private static void addBlockRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(DionaBlocks.diona_block, 4, 13), new Object[] { "QQ", "QQ", 'Q', new ItemStack(DionaBlocks.diona_block, 1, 11) });
	...
	private static void addItemRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(DionaItems.tier_4_rocket_module, 1, 0), new Object[] { "F", "C", 'F', new ItemStack(MPItems.flag, 1, 0), 'C', new ItemStack(DionaItems.tier_4_rocket_module, 1, 4) });
	...
	private static void addTier4RocketNoFlagRecipes()
	{
		...
		input.put(20, null);
		input.put(21, null);
		Tier4RocketRecipes.addTier4RocketNoFlagRecipe(new ItemStack(DionaItems.tier_4_rocket, 1, 10), input);

		HashMap<Integer, ItemStack> input2 = new HashMap<Integer, ItemStack>(input);
		input2.put(19, new ItemStack(Blocks.chest));
		input2.put(20, null);
		input2.put(21, null);
		Tier4RocketRecipes.addTier4RocketNoFlagRecipe(new ItemStack(DionaItems.tier_4_rocket, 1, 11), input2);
		...
		input2.put(20, new ItemStack(Blocks.chest));
		input2.put(21, null);
		Tier4RocketRecipes.addTier4RocketNoFlagRecipe(new ItemStack(DionaItems.tier_4_rocket, 1, 12), input2);
		...
		input2.put(20, new ItemStack(Blocks.chest));
		input2.put(21, new ItemStack(Blocks.chest));
		Tier4RocketRecipes.addTier4RocketNoFlagRecipe(new ItemStack(DionaItems.tier_4_rocket, 1, 13), input2);
	}
}