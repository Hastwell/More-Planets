...
public class RoomBossDiona extends DungeonRoom
{
    ...
    public RoomBossDiona(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomBossDiona(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        this.worldObj.setBlock(this.spawnerCoords.posX, this.spawnerCoords.posY, this.spawnerCoords.posZ, DionaBlocks.diona_block, 15, 3);
        ...
        {
            final TileEntityDungeonSpawner spawner = new TileEntityDionaDungeonSpawner();
