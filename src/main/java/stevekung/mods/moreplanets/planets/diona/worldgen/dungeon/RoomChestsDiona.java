...
public class RoomChestsDiona extends DungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public RoomChestsDiona(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    public void generate(Block[] chunk, byte[] meta, int cx, int cz)
    {
        ...
        if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, DionaBlocks.diona_ancient_chest, 0))
        {
    ...
    {
        return new RoomChestsDiona(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        {
            this.worldObj.setBlock(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ, DionaBlocks.diona_ancient_chest, 0, 2);
            TileEntityDionaAncientChest chest = (TileEntityDionaAncientChest) this.worldObj.getTileEntity(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ);
