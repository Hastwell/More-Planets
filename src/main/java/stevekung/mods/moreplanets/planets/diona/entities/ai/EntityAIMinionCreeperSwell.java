...
public class EntityAIMinionCreeperSwell extends EntityAIBase
{
    EntityDionaMinionCreeper swellingCreeper;
    EntityLivingBase creeperAttackTarget;

    public EntityAIMinionCreeperSwell(EntityDionaMinionCreeper par1EntityCreeper)
    {
