...
package stevekung.mods.moreplanets.planets.diona.render.tileentities;
...
public class TileEntityDionaAncientChestRenderer extends TileEntitySpecialRenderer
{
    ...
    private static ResourceLocation chestNormal = new ResourceLocation("diona:textures/model/diona_ancient_chest.png");
    private static ResourceLocation largeChestNormal = new ResourceLocation("diona:textures/model/diona_ancient_chest_double.png");
    ...
    public TileEntityDionaAncientChestRenderer()
    {
    ...
    public void renderTileEntityChestAt(TileEntityDionaAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockDionaAncientChest && i == 0)
            {
                try
                {
                    ((BlockDionaAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityDionaAncientChestRenderer.christmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityDionaAncientChestRenderer.steveChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityDionaAncientChestRenderer.chestNormal);
                }
            }
            else
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityDionaAncientChestRenderer.largeChristmasChest);
                }
                if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityDionaAncientChestRenderer.steveLargeChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityDionaAncientChestRenderer.largeChestNormal);
                }
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntityDionaAncientChest)par1TileEntity, par2, par4, par6, par8);
    }
}