...
public class RoomChestsDiona extends DungeonRoom
{
	...
	public RoomChestsDiona(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomChestsDiona(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), DionaBlocks.diona_ancient_chest.getDefaultState(), 2);
			TileEntityDionaAncientChest chest = (TileEntityDionaAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
