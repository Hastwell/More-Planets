...
public class RoomChestsSiriusB extends DungeonRoom
{
	...
	public RoomChestsSiriusB(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomChestsSiriusB(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), SiriusBBlocks.sirius_b_ancient_chest.getDefaultState(), 2);
			TileEntitySiriusBAncientChest chest = (TileEntitySiriusBAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
