...
public class RoomTreasureSiriusB extends DungeonRoom
{
    ...
    public RoomTreasureSiriusB(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomTreasureSiriusB(dungeon, x, y, z, dir);
    }
}