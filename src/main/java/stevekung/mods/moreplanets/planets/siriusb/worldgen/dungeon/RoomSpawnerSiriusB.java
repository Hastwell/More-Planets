...
public class RoomSpawnerSiriusB extends DungeonRoom
{
    ...
    public RoomSpawnerSiriusB(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomSpawnerSiriusB(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        for (final ChunkCoordinates spawnerCoords : this.spawners)
        {
            if (this.worldObj.getBlock(spawnerCoords.posX, spawnerCoords.posY, spawnerCoords.posZ) == Blocks.mob_spawner)
            {
                ...
                if (spawner != null)
                {
                    spawner.func_145881_a().setEntityName(RoomSpawnerSiriusB.getMob(rand));
                }
            }
        }
    }
    ...
    private static String getMob(Random rand)
    {
        ...
        {
        case 0:
            return "MorePlanet.SiriusCreeper";
        case 1:
            return "MorePlanet.SiriusBlaze";
        case 2:
            return "MorePlanet.SiriusMagmaCube";
        default:
            return "MorePlanet.SiriusCreeper";
        }
    }
