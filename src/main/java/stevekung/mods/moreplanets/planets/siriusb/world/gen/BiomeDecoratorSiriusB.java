...
public class BiomeDecoratorSiriusB extends BiomeDecoratorMP
{
    ...
    protected void genDecorations(BiomeGenBase biome)
    {
        ...
        for (int i = 0; i < this.lavaLakePerChunk; ++i)
        {
            ...
            {
                new WorldGenLiquidLakes(SiriusBBlocks.sirius_lava, SiriusBBlocks.sirius_b_block, 2).generate(this.currentWorld, this.randomGenerator, this.field_180294_c.add(this.randomGenerator.nextInt(16) + 8, this.randomGenerator.nextInt(32 - 16) + 16, this.randomGenerator.nextInt(16) + 8));
            }
        }
    }
}