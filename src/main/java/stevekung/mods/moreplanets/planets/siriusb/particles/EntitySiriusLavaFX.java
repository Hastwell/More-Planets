...
public class EntitySiriusLavaFX extends EntityFX
{
    private String texture = "siriusb:textures/particles/sirius_lava.png";
    private ResourceLocation particles = new ResourceLocation("textures/particle/particles.png");
    private float lavaParticleScale;

    public EntitySiriusLavaFX(World world, double x, double y, double z)
    {
