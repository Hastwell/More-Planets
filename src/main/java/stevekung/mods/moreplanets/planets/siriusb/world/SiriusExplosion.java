...
package stevekung.mods.moreplanets.planets.siriusb.world;
...
public class SiriusExplosion extends Explosion
{
    ...
    public SiriusExplosion(World world, Entity entity, double x, double y, double z, float size, List<BlockPos> pos)
    {
        this(world, entity, x, y, z, size, false, true, pos);
    }

    @SideOnly(Side.CLIENT)
    public SiriusExplosion(World world, Entity entity, double x, double y, double z, float size, boolean flame, boolean smoke, List<BlockPos> pos)
    {
        this(world, entity, x, y, z, size, flame, smoke);
        this.affectedBlockPositions.addAll(pos);
    }

    public SiriusExplosion(World world, Entity entity, double x, double y, double z, float size, boolean flame, boolean smoke)
    {
    ...
    public void doExplosionB(boolean spawnParticles)
    {
        ...
        if (this.isFlaming)
        {
            for (BlockPos blockpos1 : this.affectedBlockPositions)
            {
                ...
                {
                    this.worldObj.setBlockState(blockpos1, SiriusBBlocks.sirius_fire.getDefaultState());
                }
            }
        }
    }
