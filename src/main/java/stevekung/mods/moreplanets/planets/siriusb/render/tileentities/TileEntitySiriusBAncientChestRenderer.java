...
package stevekung.mods.moreplanets.planets.siriusb.render.tileentities;
...
import stevekung.mods.moreplanets.planets.siriusb.blocks.BlockSiriusBAncientChest;
...
public class TileEntitySiriusBAncientChestRenderer extends TileEntitySpecialRenderer
{
    ...
    private static final ResourceLocation chestNormal = new ResourceLocation("siriusb:textures/model/sirius_b_ancient_chest.png");
    private static final ResourceLocation largeChestNormal = new ResourceLocation("siriusb:textures/model/sirius_b_ancient_chest_double.png");;
    ...
    public TileEntitySiriusBAncientChestRenderer()
    {
    ...
    public void renderTileEntityChestAt(TileEntitySiriusBAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockSiriusBAncientChest && i == 0)
            {
                try
                {
                    ((BlockSiriusBAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntitySiriusBAncientChestRenderer.christmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntitySiriusBAncientChestRenderer.steveChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntitySiriusBAncientChestRenderer.chestNormal);
                }
            }
            else
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntitySiriusBAncientChestRenderer.largeChristmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntitySiriusBAncientChestRenderer.steveLargeChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntitySiriusBAncientChestRenderer.largeChestNormal);
                }
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntitySiriusBAncientChest)par1TileEntity, par2, par4, par6, par8);
    }
}