...
public class BlockMercuryAncientChest extends BlockAncientChestMP
{
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5)
    {
        ...
        TileEntityMercuryAncientChest tileentitychest = (TileEntityMercuryAncientChest)par1World.getTileEntity(par2, par3, par4);
    ...
    public IInventory getInventory(World par1World, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.mercury.ancientchest.name"), (TileEntityMercuryAncientChest)par1World.getTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }
            if (par1World.getBlock(par2 + 1, par3, par4) == this)
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.mercury.ancientchest.name"), (IInventory)object, (TileEntityMercuryAncientChest)par1World.getTileEntity(par2 + 1, par3, par4));
            }
            if (par1World.getBlock(par2, par3, par4 - 1) == this)
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.mercury.ancientchest.name"), (TileEntityMercuryAncientChest)par1World.getTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }
            if (par1World.getBlock(par2, par3, par4 + 1) == this)
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.mercury.ancientchest.name"), (IInventory)object, (TileEntityMercuryAncientChest)par1World.getTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
        return "mercury:mercury_ancient_chest";
    }
