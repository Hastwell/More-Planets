...
public class TileEntityMercuryAncientChest extends TileEntityAncientChestMP
{
    ...
    protected TileEntityMercuryAncientChest func_174911_a(EnumFacing side)
    {
        ...
        if (this.func_174912_b(blockpos))
        {
            ...
            {
                TileEntityMercuryAncientChest tileentitychest = (TileEntityMercuryAncientChest)tileentity;
    ...
    private void func_174910_a(TileEntityMercuryAncientChest chest, EnumFacing side)
    {
        if (chest.isInvalid())
        {
