...
public class RoomBossMercury extends DungeonRoom
{
	...
	public RoomBossMercury(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomBossMercury(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		if (tile == null || !(tile instanceof TileEntityMercuryDungeonSpawner))
		{
			TileEntityDungeonSpawner spawner = new TileEntityMercuryDungeonSpawner();
