...
package stevekung.mods.moreplanets.planets.mercury.world.gen.dungeon;
...
public class RoomChestsMercury extends DungeonRoom
{
	...
	public RoomChestsMercury(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	public void generate(Block[] chunk, byte[] meta, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, MercuryBlocks.mercury_ancient_chest, 0))
		{
	...
	{
		return new RoomChestsMercury(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), MercuryBlocks.mercury_ancient_chest.getDefaultState(), 2);
			TileEntityMercuryAncientChest chest = (TileEntityMercuryAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
