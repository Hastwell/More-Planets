...
public class TileEntityMercuryAncientChestRenderer extends TileEntitySpecialRenderer
{
    ...
    private static final ResourceLocation chestNormal = new ResourceLocation("mercury:textures/model/mercury_ancient_chest.png");
    private static final ResourceLocation largeChestNormal = new ResourceLocation("mercury:textures/model/mercury_ancient_chest_double.png");
    ...
    public TileEntityMercuryAncientChestRenderer()
    {
    ...
    public void renderTileEntityChestAt(TileEntityMercuryAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockMercuryAncientChest && i == 0)
            {
                try
                {
                    ((BlockMercuryAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityMercuryAncientChestRenderer.christmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityMercuryAncientChestRenderer.steveChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityMercuryAncientChestRenderer.chestNormal);
                }
            }
            else
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityMercuryAncientChestRenderer.largeChristmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityMercuryAncientChestRenderer.steveLargeChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityMercuryAncientChestRenderer.largeChestNormal);
                }
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntityMercuryAncientChest)par1TileEntity, par2, par4, par6, par8);
    }
}