...
public class RoomChestsMercury extends DungeonRoom
{
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        {
            this.worldObj.setBlock(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ, MercuryBlocks.mercury_ancient_chest, 0, 2);
            TileEntityMercuryAncientChest chest = (TileEntityMercuryAncientChest) this.worldObj.getTileEntity(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ);
