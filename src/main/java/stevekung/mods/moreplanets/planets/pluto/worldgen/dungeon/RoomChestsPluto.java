...
public class RoomChestsPluto extends DungeonRoom
{
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        {
            this.worldObj.setBlock(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ, PlutoBlocks.pluto_ancient_chest, 0, 2);
            TileEntityPlutoAncientChest chest = (TileEntityPlutoAncientChest) this.worldObj.getTileEntity(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ);
