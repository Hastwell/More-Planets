...
package stevekung.mods.moreplanets.planets.pluto.world.gen.dungeon;
...
public class RoomChestsPluto extends DungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public RoomChestsPluto(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	public void generate(Block[] chunk, byte[] meta, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, PlutoBlocks.pluto_ancient_chest, 0))
		{
	...
	{
		return new RoomChestsPluto(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), PlutoBlocks.pluto_ancient_chest.getDefaultState(), 2);
			TileEntityPlutoAncientChest chest = (TileEntityPlutoAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
