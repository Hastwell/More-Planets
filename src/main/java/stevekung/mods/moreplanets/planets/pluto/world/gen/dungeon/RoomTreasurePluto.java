...
public class RoomTreasurePluto extends DungeonRoom
{
    ...
    public RoomTreasurePluto(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
    {
    ...
    public void generate(ChunkPrimer chunk, int cx, int cz)
    {
        ...
        if (this.placeBlock(chunk, hx, this.posY, hz, cx, cz, PlutoBlocks.pluto_treasure_chest, 0))
        {
    ...
    {
        return new RoomTreasurePluto(dungeon, x, y, z, facing);
    }
}