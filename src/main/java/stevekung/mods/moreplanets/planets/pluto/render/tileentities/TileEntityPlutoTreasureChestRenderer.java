...
{
    private static final ResourceLocation treasureChestTexture = new ResourceLocation("pluto:textures/model/pluto_treasure_chest.png");

    private final ModelTreasureChest chestModel = new ModelTreasureChest();

    public void renderGCTileEntityTreasureChestAt(TileEntityPlutoTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        this.bindTexture(TileEntityPlutoTreasureChestRenderer.treasureChestTexture);
    ...
    {
        this.renderGCTileEntityTreasureChestAt((TileEntityPlutoTreasureChest) par1TileEntity, par2, par4, par6, par8);
    }
}