...
import stevekung.mods.moreplanets.planets.pluto.entities.ai.EntityAIPlutoDogBeg;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class EntityPlutoDog extends EntityTameable implements IEntityBreathable
{
    ...
    public EntityPlutoDog(World world)
    {
        super(world);
        ...
        this.tasks.addTask(8, new EntityAIPlutoDogBeg(this, 8.0F));
    ...
    @Override
    public EntityPlutoDog createChild(EntityAgeable p_90011_1_)
    {
        EntityPlutoDog entitywolf = new EntityPlutoDog(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof EntityPlutoDog))
        {
            return false;
        }
        else
        {
            EntityPlutoDog entitywolf = (EntityPlutoDog)p_70878_1_;
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityPlutoDog)
            {
                EntityPlutoDog entitywolf = (EntityPlutoDog)p_142018_1_;
