...
public class ItemXeoniumPickaxe extends ItemElectricPickaxeMP
{
	public ItemXeoniumPickaxe(String name, ToolMaterial material)
	{
		super(material);
		this.setTextureName("pluto:xeonium_pickaxe");
