...
public class RenderPlutoAlien extends RenderLiving<EntityPlutoAlien>
{
    ...
    @Override
    protected int getColorMultiplier(EntityPlutoAlien entity, float lightBrightness, float partialTicks)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityPlutoAlien entity)
    {
        return this.texture;
    }
}