...
public class RoomChestsNibiru extends DungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public RoomChestsNibiru(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    public void generate(Block[] chunk, byte[] meta, int cx, int cz)
    {
        ...
        if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, NibiruBlocks.nibiru_ancient_chest, 0))
        {
    ...
    {
        return new RoomChestsNibiru(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        {
            this.worldObj.setBlock(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ, NibiruBlocks.nibiru_ancient_chest, 0, 2);
            final TileEntityNibiruAncientChest chest = (TileEntityNibiruAncientChest) this.worldObj.getTileEntity(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ);
