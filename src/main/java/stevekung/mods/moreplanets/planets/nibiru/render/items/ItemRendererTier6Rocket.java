...
package stevekung.mods.moreplanets.planets.nibiru.render.items;
...
public class ItemRendererTier6Rocket extends ItemRendererTier1Rocket
{
    private final ModelBase cargoRocketModel;

    public ItemRendererTier6Rocket(ModelBase cargoRocketModel)
    {
        super(new EntityTier6Rocket(FMLClientHandler.instance().getClient().theWorld), new ModelRocketMP(), new ResourceLocation("nibiru:textures/model/tier6_rocket.png"));
