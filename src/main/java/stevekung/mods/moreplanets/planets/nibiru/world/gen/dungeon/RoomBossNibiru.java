...
public class RoomBossNibiru extends DungeonRoom
{
	...
	public RoomBossNibiru(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	protected void handleTileEntities(Random rand)
	{
		...
		this.worldObj.setBlockState(this.spawnerCoords, NibiruBlocks.nibiru_block.getDefaultState(), 3);//TODO Boss Dungeon Spawner
		...
		{
			TileEntityDungeonSpawner spawner = new TileEntityNibiruDungeonSpawner();
	...
	{
		return new RoomBossNibiru(dungeon, x, y, z, facing);
	}
}