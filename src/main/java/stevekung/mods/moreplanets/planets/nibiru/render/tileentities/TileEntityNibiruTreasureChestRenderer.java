...
public class TileEntityNibiruTreasureChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation treasureChestTexture = new ResourceLocation("nibiru:textures/model/nibiru_treasure_chest.png");

    private final ModelTreasureChest chestModel = new ModelTreasureChest();

    public void renderGCTileEntityTreasureChestAt(TileEntityNibiruTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        this.bindTexture(TileEntityNibiruTreasureChestRenderer.treasureChestTexture);
    ...
    {
        this.renderGCTileEntityTreasureChestAt((TileEntityNibiruTreasureChest) par1TileEntity, par2, par4, par6, par8);
    }
}