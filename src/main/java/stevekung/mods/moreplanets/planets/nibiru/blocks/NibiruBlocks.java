...
public class NibiruBlocks
{
    ...
    public static void init()
    {
        ...
        NibiruBlocks.ancient_dark_wood_stairs = new BlockStairsMP(Blocks.planks, "ancient_dark_wood_stairs", "wood", null, 2.0F);
        NibiruBlocks.nibiru_cobblestone_stairs = new BlockStairsMP(Blocks.stone, "nibiru_cobblestone_stairs", 2.0F);
        NibiruBlocks.orange_wood_stairs = new BlockStairsMP(Blocks.planks, "orange_wood_stairs", "wood", null, 2.0F);
        ...
        NibiruBlocks.nibiru_dungeon_brick_stairs = new BlockStairsMP(Blocks.stone, "nibiru_dungeon_brick_stairs", 4.0F);
