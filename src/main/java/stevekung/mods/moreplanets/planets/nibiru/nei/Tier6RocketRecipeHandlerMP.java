...
public class Tier6RocketRecipeHandlerMP extends RocketRecipeHandlerMP
{
	public String getRecipeId()
	{
		return "galacticraft.tier6.rocket";
	}

	public Set<Entry<ArrayList<PositionedStack>, PositionedStack>> getRecipes()
	{
		return NEITier6RocketConfig.getRocketBenchRecipes();
	}
	...
	{
		return "moreplanets:textures/gui/schematic_tier6_rocket.png";
	}
}