...
{
    private static final ResourceLocation tier6SchematicTexture = new ResourceLocation("nibiru:textures/gui/schematic_tier6_rocket.png");
    ...
    {
        this.fontRendererObj.drawString(StatCollector.translateToLocal("schematics.container.rocket.tier6"), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(GuiSchematicTier6Rocket.tier6SchematicTexture);
