...
public class RoomChestsNibiru extends DungeonRoom
{
	...
	public RoomChestsNibiru(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomChestsNibiru(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlockState(this.chests.get(0), NibiruBlocks.nibiru_ancient_chest.getDefaultState(), 2);
			TileEntityNibiruAncientChest chest = (TileEntityNibiruAncientChest) this.worldObj.getTileEntity(this.chests.get(0));
