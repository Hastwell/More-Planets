...
public class EntityTier6Rocket extends EntityTieredRocket
{
	...
	{
		return new ItemStack(NibiruItems.tier6_rocket, 1, this.rocketType.getIndex());
	}
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		ItemStack rocket = new ItemStack(NibiruItems.tier6_rocket, 1, this.rocketType.getIndex());
