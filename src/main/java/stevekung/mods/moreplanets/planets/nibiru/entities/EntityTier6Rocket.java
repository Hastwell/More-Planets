...
public class EntityTier6Rocket extends EntityTieredRocket
{
    ...
    public EntityTier6Rocket(World world, double x, double y, double z, EnumRocketType rocketType)
    {
        super(world, x, y, z);
    ...
    {
        return new ItemStack(NibiruItems.tier_6_rocket, 1, this.rocketType.getIndex());
    }
