...
package stevekung.mods.moreplanets.planets.nibiru.client.particles;
...
public class EntityGeneratorSmokeFX extends EntityFX
{
    float smokeParticleScale;

    public EntityGeneratorSmokeFX(World world, double x, double y, double z)
    {
