...
{
	private ResourceLocation texture = new ResourceLocation("moreplanets:textures/gui/tier_6_rocket_schematic.png");
	...
	{
		this.fontRendererObj.drawString(StatCollector.translateToLocal("schematics.container.rocket.noflag.tier6"), 7, -20 + 27, 4210752);
