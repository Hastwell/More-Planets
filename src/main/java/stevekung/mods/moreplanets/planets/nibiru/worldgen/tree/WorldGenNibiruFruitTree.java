...
package stevekung.mods.moreplanets.planets.nibiru.worldgen.tree;
...
public class WorldGenNibiruFruitTree extends WorldGenAbstractTree
{
    ...
    public WorldGenNibiruFruitTree(Block wood, Block leaves, int metaWood, int metaLeaves)
    {
        this(wood, leaves, metaWood, metaLeaves, false, 4, 3, false);
    }

    public WorldGenNibiruFruitTree(Block wood, Block leaves, int metaWood, boolean isFruitTree)
    {
    ...
    public WorldGenNibiruFruitTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow)
    {
        super(doBlockNotify);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockNibiruSapling)NibiruBlocks.nibiru_sapling);
