...
package stevekung.mods.moreplanets.planets.nibiru.render.tileentities;
...
public class TileEntityNibiruAncientChestRenderer extends TileEntitySpecialRenderer
{
    ...
    private static ResourceLocation chestNormal = new ResourceLocation("nibiru:textures/model/nibiru_ancient_chest.png");
    private static ResourceLocation largeChestNormal = new ResourceLocation("nibiru:textures/model/nibiru_ancient_chest_double.png");
    ...
    public TileEntityNibiruAncientChestRenderer()
    {
    ...
    public void renderTileEntityChestAt(TileEntityNibiruAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockNibiruAncientChest && i == 0)
            {
                try
                {
                    ((BlockNibiruAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityNibiruAncientChestRenderer.christmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityNibiruAncientChestRenderer.steveChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityNibiruAncientChestRenderer.chestNormal);
                }
            }
            else
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityNibiruAncientChestRenderer.largeChristmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityNibiruAncientChestRenderer.steveLargeChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityNibiruAncientChestRenderer.largeChestNormal);
                }
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntityNibiruAncientChest)par1TileEntity, par2, par4, par6, par8);
    }
}
