...
public class RoomSpawnerNibiru extends DungeonRoom
{
    ...
    public RoomSpawnerNibiru(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomSpawnerNibiru(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        for (ChunkCoordinates spawnerCoords : this.spawners)
        {
            if (this.worldObj.getBlock(spawnerCoords.posX, spawnerCoords.posY, spawnerCoords.posZ) == Blocks.mob_spawner)
            {
                ...
                if (spawner != null)
                {
                    spawner.func_145881_a().setEntityName(RoomSpawnerNibiru.getMob(rand));
                }
            }
        }
    }
    ...
    private static String getMob(Random rand)
    {
        ...
        case 5:
            return "MorePlanet.InfectedZombie";
        default:
            return "EvolvedZombie";
        }
    }
