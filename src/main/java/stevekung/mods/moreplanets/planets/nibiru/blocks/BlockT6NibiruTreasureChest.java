...
public class BlockT6NibiruTreasureChest extends BlockTreasureChestMP
{
    public BlockT6NibiruTreasureChest(String name)
    {
        super();
    ...
    {
        final TileEntityNibiruTreasureChest var7 = (TileEntityNibiruTreasureChest) par1World.getTileEntity(par2, par3, par4);
    ...
    {
        return "nibiru:nibiru_treasure_chest";
    }
