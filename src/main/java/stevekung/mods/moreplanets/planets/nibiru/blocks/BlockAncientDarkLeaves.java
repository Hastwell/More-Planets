...
public class BlockAncientDarkLeaves extends BlockLeavesBase implements IShearable
{
    ...
    public void registerBlockIcons(IIconRegister iconRegister)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            this.textures[0][i] = iconRegister.registerIcon("nibiru:nibiru_apple" + i + "_fancy");
            this.textures[1][i] = iconRegister.registerIcon("nibiru:nibiru_apple" + i + "_fast");
        }
    }
    ...
    {
        return this.textures[1][metadata & 3];
    }
