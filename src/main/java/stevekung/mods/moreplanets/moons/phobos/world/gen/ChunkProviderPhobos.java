...
public class ChunkProviderPhobos extends ChunkProviderBaseMP
{
    ...
    public void populate(IChunkProvider chunk, int chunkX, int chunkZ)
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            new WorldGenSpaceDungeons(Blocks.chest, PhobosBlocks.phobos_block, MPBlocks.space_mossy_cobblestone, 10).generate(this.worldObj, this.rand, pos.add(this.rand.nextInt(16) + 8, this.rand.nextInt(256), this.rand.nextInt(16) + 8));
        }
