...
package stevekung.mods.moreplanets.moons.io.worldgen.dungeon;
...
public class RoomTreasureIo extends DungeonRoom
{
    ...
    public RoomTreasureIo(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
