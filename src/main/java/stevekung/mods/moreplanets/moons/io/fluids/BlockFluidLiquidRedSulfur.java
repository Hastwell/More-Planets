...
public class BlockFluidLiquidRedSulfur extends BlockFluidLavaBaseMP
{
    public BlockFluidLiquidRedSulfur(String name)
    {
        super(IoBlocks.liquid_red_sulfur_fluid);
    ...
    {
        return "io:liquid_red_sulfur_still";
    }

    @Override
    public String getFlowingTextures()
    {
        return "io:liquid_red_sulfur_flowing";
    }
