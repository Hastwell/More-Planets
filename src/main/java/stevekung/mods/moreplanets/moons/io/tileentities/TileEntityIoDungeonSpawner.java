...
package stevekung.mods.moreplanets.moons.io.tileentities;
...
public class TileEntityIoDungeonSpawner extends TileEntityDungeonSpawner
{
    public TileEntityIoDungeonSpawner()
    {
