...
public class BlockFluidIoBlackLava extends BlockFluidLavaBaseMP
{
    public BlockFluidIoBlackLava(String name)
    {
        super(IoBlocks.io_black_lava_fluid);
    ...
    {
        return "io:black_lava_still";
    }

    @Override
    public String getFlowingTextures()
    {
        return "io:black_lava_flowing";
    }
