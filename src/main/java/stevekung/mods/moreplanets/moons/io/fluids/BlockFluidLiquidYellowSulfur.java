...
public class BlockFluidLiquidYellowSulfur extends BlockFluidLavaBaseMP
{
    public BlockFluidLiquidYellowSulfur(String name)
    {
        super(IoBlocks.liquid_yellow_sulfur_fluid);
    ...
    {
        return "io:liquid_yellow_sulfur_still";
    }

    @Override
    public String getFlowingTextures()
    {
        return "io:liquid_yellow_sulfur_flowing";
    }
