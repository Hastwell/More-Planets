...
package stevekung.mods.moreplanets.moons.deimos.worldgen;
...
{
	Block topBlockID = DeimosBlocks.deimos_block;
	byte topBlockMeta = 0;
	Block fillBlockID = DeimosBlocks.deimos_block;
	byte fillBlockMeta = 1;
	Block lowerBlockID = DeimosBlocks.deimos_block;
	...
	public ChunkProviderDeimos(World par1World, long par2, boolean par4)
	{
