...
public class StructureKoentusVillageStart extends StructureStart
{
    ...
    public StructureKoentusVillageStart(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        super(par3, par4);

        final ArrayList<StructureKoentusVillagePieceWeight> var6 = StructureKoentusVillagePieces.getStructureVillageWeightedPieceList(par2Random, par5);
        final ComponentKoentusVillageStartPiece var7 = new ComponentKoentusVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
