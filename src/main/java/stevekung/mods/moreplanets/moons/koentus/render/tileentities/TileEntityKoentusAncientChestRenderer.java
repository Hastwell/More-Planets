...
package stevekung.mods.moreplanets.moons.koentus.render.tileentities;
...
import stevekung.mods.moreplanets.moons.koentus.blocks.BlockKoentusAncientChest;
...
public class TileEntityKoentusAncientChestRenderer extends TileEntitySpecialRenderer
{
    ...
    private static final ResourceLocation chestNormal = new ResourceLocation("koentus:textures/model/koentus_ancient_chest.png");
    private static final ResourceLocation largeChestNormal = new ResourceLocation("koentus:textures/model/koentus_ancient_chest_double.png");
    ...
    public TileEntityKoentusAncientChestRenderer()
    {
    ...
    public void renderTileEntityChestAt(TileEntityKoentusAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockKoentusAncientChest && i == 0)
            {
                try
                {
                    ((BlockKoentusAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityKoentusAncientChestRenderer.christmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityKoentusAncientChestRenderer.steveChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityKoentusAncientChestRenderer.chestNormal);
                }
            }
            else
            {
                ...
                if (this.isChristmas)
                {
                    this.bindTexture(TileEntityKoentusAncientChestRenderer.largeChristmasChest);
                }
                else if (this.isSteveBirthDay)
                {
                    this.bindTexture(TileEntityKoentusAncientChestRenderer.steveLargeChestNormal);
                }
                else
                {
                    this.bindTexture(TileEntityKoentusAncientChestRenderer.largeChestNormal);
                }
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntityKoentusAncientChest)par1TileEntity, par2, par4, par6, par8);
    }
}