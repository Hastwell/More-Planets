...
public class RoomBossKoentus extends DungeonRoom
{
    ...
    public RoomBossKoentus(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomBossKoentus(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        this.worldObj.setBlock(this.spawnerCoords.posX, this.spawnerCoords.posY, this.spawnerCoords.posZ, KoentusBlocks.koentus_block, 14, 3);
        ...
        {
            final TileEntityDungeonSpawner spawner = new TileEntityKoentusDungeonSpawner();
