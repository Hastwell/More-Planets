...
public class SkyProviderKoentus extends SkyProviderBaseMP
{
    ...
    public SkyProviderKoentus(IGalacticraftWorldProvider provider)
    {
        super();
    ...
    protected void renderPlanetInSky(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        GlStateManager.rotate(1000F, 1.0F, 0.0F, 0.0F);
        ...
        GlStateManager.rotate(world.getCelestialAngle(partialTicks) * 360.0F, 1.0F, 0.0F, 0.0F);
        GlStateManager.scale(0.6F, 0.6F, 0.6F);
        GlStateManager.rotate(40.0F, 50.0F, 120.0F, 1.0F);
        GlStateManager.rotate(200F, 1.0F, 0.0F, -0.1F);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1F);
