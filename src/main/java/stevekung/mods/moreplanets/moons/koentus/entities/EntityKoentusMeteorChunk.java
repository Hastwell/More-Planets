...
public class EntityKoentusMeteorChunk extends Entity implements IProjectile
{
	...
	public EntityKoentusMeteorChunk(World world, EntityLivingBase shootingEntity, EntityLivingBase target, float speed, float randMod)
	{
		super(world);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityKoentusMeteorChunk(World par1World, EntityLivingBase par2EntityLivingBase, float speed)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
	{
		if (!this.worldObj.isRemote && this.inGround)
		{
			...
			if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(KoentusItems.koentus_meteor_chunk, 1, 0)))
			{
				flag = false;
			}
