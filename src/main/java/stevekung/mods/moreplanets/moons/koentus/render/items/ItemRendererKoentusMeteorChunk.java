...
package stevekung.mods.moreplanets.moons.koentus.render.items;
...
public class ItemRendererKoentusMeteorChunk implements IItemRenderer
{
    ...
    private void renderMeteorChunk(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        ...
        FMLClientHandler.instance().getClient().getTextureManager().bindTexture(ItemRendererKoentusMeteorChunk.meteorChunkTexture);
