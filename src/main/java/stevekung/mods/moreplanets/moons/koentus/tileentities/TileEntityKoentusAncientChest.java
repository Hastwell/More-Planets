...
public class TileEntityKoentusAncientChest extends TileEntityAncientChestMP
{
    ...
    protected TileEntityKoentusAncientChest func_174911_a(EnumFacing side)
    {
        ...
        if (this.func_174912_b(blockpos))
        {
            ...
            {
                TileEntityKoentusAncientChest tileentitychest = (TileEntityKoentusAncientChest)tileentity;
    ...
    private void func_174910_a(TileEntityKoentusAncientChest chest, EnumFacing side)
    {
        if (chest.isInvalid())
        {
