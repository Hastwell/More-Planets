...
public class RoomBossKoentus extends DungeonRoom
{
	...
	public RoomBossKoentus(MapGenDungeon dungeon, int x, int y, int z, EnumFacing facing)
	{
	...
	{
		return new RoomBossKoentus(dungeon, x, y, z, facing);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			TileEntityDungeonSpawner spawner = new TileEntityKoentusDungeonSpawner();
