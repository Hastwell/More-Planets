...
public class BlockKoentusAncientChest extends BlockAncientChestMP
{
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5)
    {
        ...
        TileEntityKoentusAncientChest tileentitychest = (TileEntityKoentusAncientChest)par1World.getTileEntity(par2, par3, par4);
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
        ...
        else if (par1World.rand.nextInt(10) == 0 && !player.capabilities.isCreativeMode)
        {
            if (!par1World.isRemote)
            {
                EntityKoentusSludgeling sludgeling = new EntityKoentusSludgeling(par1World);
    ...
    public IInventory getInventory(World par1World, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.koentus.ancientchest.name"), (TileEntityKoentusAncientChest)par1World.getTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlock(par2 + 1, par3, par4) == this)
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.koentus.ancientchest.name"), (IInventory)object, (TileEntityKoentusAncientChest)par1World.getTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlock(par2, par3, par4 - 1) == this)
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.koentus.ancientchest.name"), (TileEntityKoentusAncientChest)par1World.getTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlock(par2, par3, par4 + 1) == this)
            {
                object = new InventoryLargeChest(StatCollector.translateToLocal("container.koentus.ancientchest.name"), (IInventory)object, (TileEntityKoentusAncientChest)par1World.getTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
        return "koentus:koentus_ancient_chest";
    }
