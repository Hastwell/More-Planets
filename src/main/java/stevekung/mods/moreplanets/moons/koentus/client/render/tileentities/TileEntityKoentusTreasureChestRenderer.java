...
package stevekung.mods.moreplanets.moons.koentus.client.render.tileentities;
...
{
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/koentus_treasure_chest.png");
	private ModelTreasureChest simpleChest = new ModelTreasureChest();

	public void func_180538_a(TileEntityKoentusTreasureChest chest, double p_180538_2_, double p_180538_4_, double p_180538_6_, float p_180538_8_, int p_180538_9_)
	{
		int j;
	...
	{
		this.func_180538_a((TileEntityKoentusTreasureChest)p_180535_1_, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
	}
}