...
public class BiomeGenBaseKoentus extends BiomeGenBaseMP
{
    public static BiomeGenBase koentus = new BiomeGenBaseKoentus().setBiomeName("Koentus");

    public BiomeGenBaseKoentus()
    {
        super(ConfigManagerMP.idKoentusBiome);
