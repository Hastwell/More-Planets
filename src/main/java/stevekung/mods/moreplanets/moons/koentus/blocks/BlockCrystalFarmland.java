...
public class BlockCrystalFarmland extends Block
{
	private IIcon wet;
	private IIcon dry;
	...
	{
		return par1 == 1 ? par2 > 0 ? this.wet : this.dry : KoentusBlocks.crystal_dirt.getBlockTextureFromSide(par1);
	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		if (!this.isWaterNearby(par1World, par2, par3, par4) && !par1World.canLightningStrikeAt(par2, par3 + 1, par4))
		{
			...
			{
				par1World.setBlock(par2, par3, par4, KoentusBlocks.crystal_dirt);
			}
		}
		else
		{
	...
	{
		this.wet = par1IconRegister.registerIcon("koentus:crystal_farmland_wet");
		this.dry = par1IconRegister.registerIcon("koentus:crystal_farmland_dry");
	}
}