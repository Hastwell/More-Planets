...
public class RenderEuropaWaterBomb extends Render
{
	...
	public void doRender(EntityEuropaWaterBomb entity, double x, double y, double z, float p_76986_8_, float partialTicks)
	{
		...
		blockrendererdispatcher.renderBlockBrightness(EuropaBlocks.europa_water_bomb.getDefaultState(), entity.getBrightness(partialTicks));
		...
		if (entity.fuse / 5 % 2 == 0)
		{
			...
			blockrendererdispatcher.renderBlockBrightness(EuropaBlocks.europa_water_bomb.getDefaultState(), 1.0F);
