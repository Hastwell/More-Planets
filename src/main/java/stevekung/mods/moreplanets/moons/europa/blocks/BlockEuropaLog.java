...
public class BlockEuropaLog extends BlockLogMP
{
    public static PropertyEnum VARIANT = PropertyEnum.create("variant", BlockType.class);

    public BlockEuropaLog(String name)
    {
        super();
        this.setDefaultState(this.getDefaultState().withProperty(VARIANT, BlockType.europa_wood).withProperty(BlockStateHelper.AXIS, EnumAxis.Y));
