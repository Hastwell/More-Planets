...
public class BlockEuropaWaterBomb extends BlockBaseMP
{
	...
	public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion)
	{
		...
		{
			EntityEuropaWaterBomb entitytntprimed = new EntityEuropaWaterBomb(par1World, par2 + 0.5F, par3 + 0.5F, par4 + 0.5F, par5Explosion.getExplosivePlacedBy());
	...
	public void primeTnt(World par1World, int par2, int par3, int par4, int par5, EntityLivingBase par6EntityLivingBase)
	{
		if (!par1World.isRemote)
		{
			if ((par5 & 1) == 1)
			{
				EntityEuropaWaterBomb entitytntprimed = new EntityEuropaWaterBomb(par1World, par2 + 0.5F, par3 + 0.5F, par4 + 0.5F, par6EntityLivingBase);
				par1World.spawnEntityInWorld(entitytntprimed);
