...
import stevekung.mods.moreplanets.moons.europa.blocks.BlockEuropaPrismarine;
import stevekung.mods.moreplanets.moons.europa.blocks.EuropaBlocks;
import stevekung.mods.moreplanets.moons.europa.entities.EntityEuropaGuardian;

import com.google.common.collect.Lists;

public class StructureEuropaOceanMonumentPieces
{
	public static void func_175970_a()
	{
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.MonumentBuilding.class, "EuropaOMB");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.MonumentCoreRoom.class, "EuropaOMCR");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.DoubleXRoom.class, "EuropaOMDXR");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.DoubleXYRoom.class, "EuropaOMDXYR");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.DoubleYRoom.class, "EuropaOMDYR");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.DoubleYZRoom.class, "EuropaOMDYZR");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.DoubleZRoom.class, "EuropaOMDZR");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.EntryRoom.class, "EuropaOMEntry");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.Penthouse.class, "EuropaOMPenthouse");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.SimpleRoom.class, "EuropaOMSimple");
		MapGenStructureIO.registerStructureComponent(StructureEuropaOceanMonumentPieces.SimpleTopRoom.class, "EuropaOMSimpleT");
	}

	public static class DoubleXRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public DoubleXRoom() {}

		public DoubleXRoom(EnumFacing p_i45597_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45597_2_, Random p_i45597_3_)
		{
		...
		{
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
			...
			{
				this.func_175821_a(world, p_74875_3_, 8, 0, roomdefinition.field_175966_c[EnumFacing.DOWN.getIndex()]);
				this.func_175821_a(world, p_74875_3_, 0, 0, roomdefinition1.field_175966_c[EnumFacing.DOWN.getIndex()]);
			}

			if (roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()] == null)
			{
				this.func_175819_a(world, p_74875_3_, 1, 4, 1, 7, 4, 6, field_175828_a);
			}
	...
	public static class DoubleXYRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public DoubleXYRoom() {}

		public DoubleXYRoom(EnumFacing p_i45596_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45596_2_, Random p_i45596_3_)
		{
		...
		public boolean addComponentParts(World world, Random p_74875_2_, StructureBoundingBox p_74875_3_)
		{
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition1 = this.field_175830_k;
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition2 = roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()];
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition3 = roomdefinition.field_175965_b[EnumFacing.UP.getIndex()];
			...
			{
				this.func_175819_a(world, p_74875_3_, 1, 8, 1, 7, 8, 6, field_175828_a);
			}

			if (roomdefinition3.field_175965_b[EnumFacing.UP.getIndex()] == null)
			{
				this.func_175819_a(world, p_74875_3_, 8, 8, 1, 14, 8, 6, field_175828_a);
			}
	...
	public static class DoubleYRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public DoubleYRoom() {}

		public DoubleYRoom(EnumFacing p_i45595_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45595_2_, Random p_i45595_3_)
		{
		...
		public boolean addComponentParts(World world, Random p_74875_2_, StructureBoundingBox p_74875_3_)
		{
			if (this.field_175830_k.field_175967_a / 25 > 0)
			{
				this.func_175821_a(world, p_74875_3_, 0, 0, this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()]);
			}

			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.UP.getIndex()];
	...
	public static class DoubleYZRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public DoubleYZRoom() {}

		public DoubleYZRoom(EnumFacing p_i45594_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45594_2_, Random p_i45594_3_)
		{
		...
		public boolean addComponentParts(World world, Random p_74875_2_, StructureBoundingBox p_74875_3_)
		{
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.NORTH.getIndex()];
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition1 = this.field_175830_k;
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition2 = roomdefinition.field_175965_b[EnumFacing.UP.getIndex()];
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition3 = roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()];

			if (this.field_175830_k.field_175967_a / 25 > 0)
			{
				this.func_175821_a(world, p_74875_3_, 0, 8, roomdefinition.field_175966_c[EnumFacing.DOWN.getIndex()]);
				this.func_175821_a(world, p_74875_3_, 0, 0, roomdefinition1.field_175966_c[EnumFacing.DOWN.getIndex()]);
			}

			if (roomdefinition3.field_175965_b[EnumFacing.UP.getIndex()] == null)
			{
				this.func_175819_a(world, p_74875_3_, 1, 8, 1, 6, 8, 7, field_175828_a);
			}

			if (roomdefinition2.field_175965_b[EnumFacing.UP.getIndex()] == null)
			{
				this.func_175819_a(world, p_74875_3_, 1, 8, 8, 6, 8, 14, field_175828_a);
			}
	...
	public static class DoubleZRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public DoubleZRoom() {}

		public DoubleZRoom(EnumFacing p_i45593_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45593_2_, Random p_i45593_3_)
		{
		...
		public boolean addComponentParts(World world, Random p_74875_2_, StructureBoundingBox p_74875_3_)
		{
			...
			if (roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()] == null)
			{
				this.func_175819_a(world, p_74875_3_, 1, 4, 1, 6, 4, 7, field_175828_a);
			}
	...
	public static class EntryRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public EntryRoom() {}

		public EntryRoom(EnumFacing p_i45592_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45592_2_)
		{
	...
	static class FitSimpleRoomHelper implements StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper
	{
		private FitSimpleRoomHelper() {}

		@Override
		public boolean func_175969_a(StructureEuropaOceanMonumentPieces.RoomDefinition p_175969_1_)
		{
			return true;
		}

		@Override
		public StructureEuropaOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
		{
			p_175968_2_.field_175963_d = true;
			return new StructureEuropaOceanMonumentPieces.SimpleRoom(p_175968_1_, p_175968_2_, p_175968_3_);
		}

		FitSimpleRoomHelper(StructureEuropaOceanMonumentPieces.SwitchEnumFacing p_i45601_1_)
		{
			this();
		}
	}

	static class FitSimpleRoomTopHelper implements StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper
	{
		...
		{
			p_175968_2_.field_175963_d = true;
			return new StructureEuropaOceanMonumentPieces.SimpleTopRoom(p_175968_1_, p_175968_2_, p_175968_3_);
		}

		FitSimpleRoomTopHelper(StructureEuropaOceanMonumentPieces.SwitchEnumFacing p_i45600_1_)
		{
			this();
		}
	}

	public static class MonumentBuilding extends StructureEuropaOceanMonumentPieces.Piece
	{
		private StructureEuropaOceanMonumentPieces.RoomDefinition field_175845_o;
		private StructureEuropaOceanMonumentPieces.RoomDefinition field_175844_p;
		...
		public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_)
		{
			...
			switch (StructureEuropaOceanMonumentPieces.SwitchEnumFacing.field_175971_a[this.coordBaseMode.ordinal()])
			{
			case 1:
			case 2:
			...
			this.field_175843_q.add(new StructureEuropaOceanMonumentPieces.EntryRoom(this.coordBaseMode, this.field_175845_o));
			this.field_175843_q.add(new StructureEuropaOceanMonumentPieces.MonumentCoreRoom(this.coordBaseMode, this.field_175844_p, p_i45599_1_));
			ArrayList arraylist = Lists.newArrayList();
			arraylist.add(new StructureEuropaOceanMonumentPieces.XYDoubleRoomFitHelper((StructureEuropaOceanMonumentPieces.SwitchEnumFacing)null));
			arraylist.add(new StructureEuropaOceanMonumentPieces.YZDoubleRoomFitHelper((StructureEuropaOceanMonumentPieces.SwitchEnumFacing)null));
			arraylist.add(new StructureEuropaOceanMonumentPieces.ZDoubleRoomFitHelper((StructureEuropaOceanMonumentPieces.SwitchEnumFacing)null));
			arraylist.add(new StructureEuropaOceanMonumentPieces.XDoubleRoomFitHelper((StructureEuropaOceanMonumentPieces.SwitchEnumFacing)null));
			arraylist.add(new StructureEuropaOceanMonumentPieces.YDoubleRoomFitHelper((StructureEuropaOceanMonumentPieces.SwitchEnumFacing)null));
			arraylist.add(new StructureEuropaOceanMonumentPieces.FitSimpleRoomTopHelper((StructureEuropaOceanMonumentPieces.SwitchEnumFacing)null));
			arraylist.add(new StructureEuropaOceanMonumentPieces.FitSimpleRoomHelper((StructureEuropaOceanMonumentPieces.SwitchEnumFacing)null));
			Iterator iterator = list.iterator();

			while (iterator.hasNext())
			{
				StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = (StructureEuropaOceanMonumentPieces.RoomDefinition)iterator.next();
				...
				if (!roomdefinition.field_175963_d && !roomdefinition.func_175961_b())
				{
					...
					{
						StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper monumentroomfithelper = (StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper)iterator1.next();
			...
			{
				StructureEuropaOceanMonumentPieces.Piece piece = (StructureEuropaOceanMonumentPieces.Piece)iterator2.next();
			...
			this.field_175843_q.add(new StructureEuropaOceanMonumentPieces.WingRoom(this.coordBaseMode, structureboundingbox1, k++));
			this.field_175843_q.add(new StructureEuropaOceanMonumentPieces.WingRoom(this.coordBaseMode, structureboundingbox2, k++));
			this.field_175843_q.add(new StructureEuropaOceanMonumentPieces.Penthouse(this.coordBaseMode, structureboundingbox));
		}

		private List func_175836_a(Random p_175836_1_)
		{
			StructureEuropaOceanMonumentPieces.RoomDefinition[] aroomdefinition = new StructureEuropaOceanMonumentPieces.RoomDefinition[75];
			int i;
			int j;
			byte b0;
			int k;
			...
			for (i = 0; i < 5; ++i)
			{
				for (j = 0; j < 4; ++j)
				{
					...
					aroomdefinition[k] = new StructureEuropaOceanMonumentPieces.RoomDefinition(k);
				}
			}
			...
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition;
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition1;
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition2;
			aroomdefinition[field_175831_h].func_175957_a(EnumFacing.UP, roomdefinition = new StructureEuropaOceanMonumentPieces.RoomDefinition(1003));
			aroomdefinition[field_175832_i].func_175957_a(EnumFacing.SOUTH, roomdefinition1 = new StructureEuropaOceanMonumentPieces.RoomDefinition(1001));
			aroomdefinition[field_175829_j].func_175957_a(EnumFacing.SOUTH, roomdefinition2 = new StructureEuropaOceanMonumentPieces.RoomDefinition(1002));
			...
			ArrayList arraylist = Lists.newArrayList();
			StructureEuropaOceanMonumentPieces.RoomDefinition[] aroomdefinition1 = aroomdefinition;
			l = aroomdefinition.length;

			for (i1 = 0; i1 < l; ++i1)
			{
				StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition4 = aroomdefinition1[i1];
			...
			while (iterator.hasNext())
			{
				StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition3 = (StructureEuropaOceanMonumentPieces.RoomDefinition)iterator.next();
				int l2 = 0;
				j1 = 0;
		...
		public boolean addComponentParts(World world, Random p_74875_2_, StructureBoundingBox p_74875_3_)
		{
			this.func_175840_a(false, 0, world, p_74875_2_, p_74875_3_);
			this.func_175840_a(true, 33, world, p_74875_2_, p_74875_3_);
			this.func_175839_b(world, p_74875_2_, p_74875_3_);
			this.func_175837_c(world, p_74875_2_, p_74875_3_);
			this.func_175841_d(world, p_74875_2_, p_74875_3_);
			this.func_175835_e(world, p_74875_2_, p_74875_3_);
			this.func_175842_f(world, p_74875_2_, p_74875_3_);
			this.func_175838_g(world, p_74875_2_, p_74875_3_);
			int i;
			...
			while (iterator.hasNext())
			{
				StructureEuropaOceanMonumentPieces.Piece piece = (StructureEuropaOceanMonumentPieces.Piece)iterator.next();

				if (piece.getBoundingBox().intersectsWith(p_74875_3_))
				{
					piece.addComponentParts(world, p_74875_2_, p_74875_3_);
				}
			}
			return true;
		}
	...
	public static class MonumentCoreRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public MonumentCoreRoom() {}

		public MonumentCoreRoom(EnumFacing p_i45598_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45598_2_, Random p_i45598_3_)
		{
	...
	{
		boolean func_175969_a(StructureEuropaOceanMonumentPieces.RoomDefinition p_175969_1_);

		StructureEuropaOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_);
	}

	public static class Penthouse extends StructureEuropaOceanMonumentPieces.Piece
	{
		public Penthouse() {}
	...
	{
		protected static IBlockState field_175828_a = EuropaBlocks.europa_prismarine.getDefaultState().withProperty(BlockEuropaPrismarine.VARIANT, BlockEuropaPrismarine.BlockType.europa_prismarine);
		protected static IBlockState field_175826_b = EuropaBlocks.europa_prismarine.getDefaultState().withProperty(BlockEuropaPrismarine.VARIANT, BlockEuropaPrismarine.BlockType.europa_prismarine_bricks);
		...
		protected static int field_175829_j = func_175820_a(4, 1, 0);
		protected StructureEuropaOceanMonumentPieces.RoomDefinition field_175830_k;
		...
		protected Piece(int p_i45590_1_, EnumFacing p_i45590_2_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45590_3_, int p_i45590_4_, int p_i45590_5_, int p_i45590_6_)
		{
			super(p_i45590_1_);
			...
			switch (StructureEuropaOceanMonumentPieces.SwitchEnumFacing.field_175971_a[p_i45590_2_.ordinal()])
			{
			case 1:
	...
	{
		int field_175967_a;
		StructureEuropaOceanMonumentPieces.RoomDefinition[] field_175965_b = new StructureEuropaOceanMonumentPieces.RoomDefinition[6];
		...
		public void func_175957_a(EnumFacing p_175957_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175957_2_)
		{
	...
	public static class SimpleRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		private int field_175833_o;
		public SimpleRoom() {}

		public SimpleRoom(EnumFacing p_i45587_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45587_2_, Random p_i45587_3_)
		{
		...
		public boolean addComponentParts(World world, Random p_74875_2_, StructureBoundingBox p_74875_3_)
		{
			...
			{
				this.func_175819_a(world, p_74875_3_, 1, 4, 1, 6, 4, 6, field_175828_a);
			}
	...
	public static class SimpleTopRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
		public SimpleTopRoom() {}

		public SimpleTopRoom(EnumFacing p_i45586_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_i45586_2_, Random p_i45586_3_)
		{
	...
	{
		static int[] field_175971_a = new int[EnumFacing.values().length];
	...
	public static class WingRoom extends StructureEuropaOceanMonumentPieces.Piece
	{
	...
	static class XDoubleRoomFitHelper implements StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper
	{
		...
		public StructureEuropaOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
		{
			...
			return new StructureEuropaOceanMonumentPieces.DoubleXRoom(p_175968_1_, p_175968_2_, p_175968_3_);
		}

		XDoubleRoomFitHelper(StructureEuropaOceanMonumentPieces.SwitchEnumFacing p_i45606_1_)
		{
			this();
		}
	}

	static class XYDoubleRoomFitHelper implements StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper
	{
		...
		public boolean func_175969_a(StructureEuropaOceanMonumentPieces.RoomDefinition p_175969_1_)
		{
			...
			{
				StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()];
		...
		public StructureEuropaOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
		{
			...
			return new StructureEuropaOceanMonumentPieces.DoubleXYRoom(p_175968_1_, p_175968_2_, p_175968_3_);
		}

		XYDoubleRoomFitHelper(StructureEuropaOceanMonumentPieces.SwitchEnumFacing p_i45605_1_)
		{
			this();
		}
	}

	static class YDoubleRoomFitHelper implements StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper
	{
		...
		public StructureEuropaOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
		{
			p_175968_2_.field_175963_d = true;
			p_175968_2_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d = true;
			return new StructureEuropaOceanMonumentPieces.DoubleYRoom(p_175968_1_, p_175968_2_, p_175968_3_);
		}

		YDoubleRoomFitHelper(StructureEuropaOceanMonumentPieces.SwitchEnumFacing p_i45604_1_)
		{
			this();
		}
	}

	static class YZDoubleRoomFitHelper implements StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper
	{
		...
		public boolean func_175969_a(StructureEuropaOceanMonumentPieces.RoomDefinition p_175969_1_)
		{
			...
			{
				StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()];
				return roomdefinition.field_175966_c[EnumFacing.UP.getIndex()] && !roomdefinition.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d;
			}
			else
			{
		...
		public StructureEuropaOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
		{
			...
			return new StructureEuropaOceanMonumentPieces.DoubleYZRoom(p_175968_1_, p_175968_2_, p_175968_3_);
		}

		YZDoubleRoomFitHelper(StructureEuropaOceanMonumentPieces.SwitchEnumFacing p_i45603_1_)
		{
			this();
		}
	}

	static class ZDoubleRoomFitHelper implements StructureEuropaOceanMonumentPieces.MonumentRoomFitHelper
	{
		...
		public StructureEuropaOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureEuropaOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
		{
			StructureEuropaOceanMonumentPieces.RoomDefinition roomdefinition = p_175968_2_;
			...
			return new StructureEuropaOceanMonumentPieces.DoubleZRoom(p_175968_1_, roomdefinition, p_175968_3_);
		}

		ZDoubleRoomFitHelper(StructureEuropaOceanMonumentPieces.SwitchEnumFacing p_i45602_1_)
		{
			this();
		}
	}
