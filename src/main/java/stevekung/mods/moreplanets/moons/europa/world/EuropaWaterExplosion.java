...
public class EuropaWaterExplosion extends Explosion
{
	...
	public EuropaWaterExplosion(World world, Entity entity, double x, double y, double z, float size, boolean flaming, boolean smoking)
	{
	...
	{
		return this.exploder == null ? null : this.exploder instanceof EntityEuropaWaterBomb ? ((EntityEuropaWaterBomb)this.exploder).getTntPlacedBy() : this.exploder instanceof EntityLivingBase ? (EntityLivingBase)this.exploder : null;
	}
