...
package stevekung.mods.moreplanets.moons.europa.world;
...
public class EuropaWaterExplosion extends Explosion
{
    ...
    public EuropaWaterExplosion(World world, Entity entity, double x, double y, double z, float size, List<BlockPos> pos)
    {
        this(world, entity, x, y, z, size, true, pos);
    }

    @SideOnly(Side.CLIENT)
    public EuropaWaterExplosion(World world, Entity entity, double x, double y, double z, float size, boolean smoke, List<BlockPos> pos)
    {
        this(world, entity, x, y, z, size, smoke);
        this.affectedBlockPositions.addAll(pos);
    }

    public EuropaWaterExplosion(World world, Entity entity, double x, double y, double z, float size, boolean smoke)
    {
        super(world, entity, x, y, z, size, false, smoke);
        ...
        if (this.isSmoking)
        {
            for (BlockPos blockpos : this.affectedBlockPositions)
            {
                ...
                if (block.getMaterial() != Material.air)
                {
                    ...
                    this.worldObj.setBlockState(blockpos, EuropaBlocks.europa_water.getDefaultState());
                }
            }
        }
    }
