...
public class EuropaWaterExplosion extends Explosion
{
    ...
    public EuropaWaterExplosion(World p_i1948_1_, Entity p_i1948_2_, double p_i1948_3_, double p_i1948_5_, double p_i1948_7_, float p_i1948_9_)
    {
        ...
        if (this.isSmoking)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (block.getMaterial() != Material.air)
                {
                    ...
                    this.worldObj.setBlock(i, j, k, EuropaBlocks.europa_water);
                }
            }
        }
