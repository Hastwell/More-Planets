...
public class LayerEuropaCrabEyes implements LayerRenderer<EntityEuropaCrab>
{
    ...
    @Override
    public void doRenderLayer(EntityEuropaCrab entity, float par2, float par3, float partialTicks, float par5, float par6, float par7, float scale)
    {
