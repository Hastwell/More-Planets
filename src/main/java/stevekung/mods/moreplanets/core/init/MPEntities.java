...
import stevekung.mods.moreplanets.common.todo.EntityBlackHole;
...
public class MPEntities
{
    ...
    private static void registerNonMobEntities()
    {
        ...
        CommonRegisterHelper.registerNonMobEntity(EntityBlackHole.class, "BlackHole", MorePlanetsCore.INSTANCE, true);
