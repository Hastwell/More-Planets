...
public class MPPotions
{
	...
	private static void intializePotions()
	{
		...
		MPPotions.electro_magnetic_pulse = new EMPEffect(true, -14258727).setPotionName("potion.emp").registerPotionAttributeModifier(SharedMonsterAttributes.movementSpeed, "7107DE5E-7CE8-4030-940E-514C1F160890", -2.5D, 2);
