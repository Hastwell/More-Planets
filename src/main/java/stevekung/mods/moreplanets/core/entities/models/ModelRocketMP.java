...
public class ModelRocketMP extends ModelBase
{
    ...
    public ModelRocketMP()
    {
        ...
        this.flag = new ModelRenderer(this, 214, 0);
        this.flag.addBox(0F, 0F, 0F, 20, 12, 1, 0F);
        this.flag.setRotationPoint(-0.5F, -66.9F, -0.5F);
        this.flag.mirror = false;
