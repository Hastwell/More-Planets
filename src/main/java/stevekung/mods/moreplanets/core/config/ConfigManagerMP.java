...
public class ConfigManagerMP
{
    ...
    public static void syncConfig(boolean load)
    {
        ...
        try
        {
            ...
            prop = ConfigManagerMP.config.get(ConfigManagerMP.SCHEMATICS, "Tier 4 Rocket No Flag Schematic ID", 805);
            ConfigManagerMP.idSchematicTier4RocketNoFlag = prop.getInt();
            propOrder.add(prop.getName());

            prop = ConfigManagerMP.config.get(ConfigManagerMP.SCHEMATICS, "Tier 5 Rocket No Flag Schematic ID", 806);
            ConfigManagerMP.idSchematicTier5RocketNoFlag = prop.getInt();
            propOrder.add(prop.getName());

            prop = ConfigManagerMP.config.get(ConfigManagerMP.SCHEMATICS, "Tier 6 Rocket No Flag Schematic ID", 807);
