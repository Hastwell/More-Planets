...
public class RoomEmptyMP extends DungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;

    public RoomEmptyMP(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomEmptyMP(dungeon, x, y, z, dir);
    }
