...
public class StructureMartianVillageStart extends StructureStart
{
    ...
    public StructureMartianVillageStart(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        super(par3, par4);

        final ArrayList<StructureMartianVillagePieceWeight> var6 = StructureMartianVillagePieces.getStructureVillageWeightedPieceList(par2Random, par5);
        final ComponentMartianVillageStartPiece var7 = new ComponentMartianVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
        ...
        while (var13.hasNext())
        {
            ...
            if (!(var12 instanceof ComponentMartianVillageRoadPiece))
            {
                ++var10;
            }
        }
