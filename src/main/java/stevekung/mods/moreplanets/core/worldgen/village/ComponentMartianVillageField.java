...
public class ComponentMartianVillageField extends ComponentMartianVillage
{
    ...
    public ComponentMartianVillageField(ComponentMartianVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentMartianVillageField func_74900_a(ComponentMartianVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 13, 4, 9, par6);
        return StructureComponent.findIntersecting(par1List, var8) == null ? new ComponentMartianVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
        ...
        for (var4 = 1; var4 <= 7; ++var4)
        {
            for (int i = 1; i < 12; i++)
            {
                ...
                else
                {
                    ...
                    {
                        this.placeBlockAtCurrentPosition(par1World, Blocks.sapling, par2Random.nextInt(4), i, 1, var4, par3StructureBoundingBox);
                    }
                }
            }
        }
