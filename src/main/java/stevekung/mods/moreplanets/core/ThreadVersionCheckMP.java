...
public class ThreadVersionCheckMP extends Thread
{
    ...
    public void run()
    {
        ...
        while (this.count < 3 && remoteBuildVer == 0)
        {
            try
            {
                URL url = new URL("https://raw.githubusercontent.com/SteveKunG/More-Planets/1.7.10/version.txt");
