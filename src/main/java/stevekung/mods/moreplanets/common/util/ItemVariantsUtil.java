...
public class ItemVariantsUtil
{
	public static void registerItemVariants()
	{
		...
		RegisterHelper.registerVariantsName(FronosItems.fronos_bucket, new String[] { "moreplanets:coconut_milk_bucket", "moreplanets:mineral_water_bucket", "moreplanets:ovaltine_bucket", "moreplanets:tea_bucket", "moreplanets:caramel_bucket" });
