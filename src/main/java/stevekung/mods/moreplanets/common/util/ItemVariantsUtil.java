...
public class ItemVariantsUtil
{
	public static void registerItemVariants()
	{
		...
		RegisterHelper.registerVariantsName(FronosItems.candy_food, new String[] { "moreplanets:ovantine_powder", "moreplanets:chocolate_bars", "moreplanets:caramel" });
		...
		RegisterHelper.registerVariantsName(FronosItems.fronos_bucket, new String[] { "moreplanets:coconut_milk_bucket", "moreplanets:mineral_water_bucket", "moreplanets:ovantine_bucket", "moreplanets:tea_bucket", "moreplanets:caramel_bucket" });
		...
		RegisterHelper.registerVariantsName(FronosItems.cup, new String[] { "moreplanets:empty_cup", "moreplanets:mineral_water_cup", "moreplanets:ovantine_cup", "moreplanets:coconut_milk_cup", "moreplanets:cheese_of_milk_cup", "moreplanets:tea_cup", "moreplanets:caramel_cup" });
