...
public class ItemElectricPickaxeMP extends ItemPickaxe implements IItemElectric
{
    ...
    public ItemElectricPickaxeMP(String name, ToolMaterial material, float maxPower, IToolEffect effect)
    {
        super(material);
