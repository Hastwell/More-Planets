...
public class CraftingManagerMP
{
    ...
    private static void registerNormalRecipes()
    {
        ...
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 0), new ItemStack(Items.gold_ingot), 0.8F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 1), new ItemStack(Items.diamond), 0.8F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 2), new ItemStack(Items.emerald), 0.8F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 3), new ItemStack(GCItems.basicItem, 1, 2), 0.8F);
