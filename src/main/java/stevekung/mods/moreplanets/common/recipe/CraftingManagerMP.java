...
import stevekung.mods.moreplanets.common.util.EnumItemUtil;
...
public class CraftingManagerMP
{
    ...
    private static void registerNormalRecipes()
    {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(MPBlocks.space_mossy_cobblestone, 1, 4), new ItemStack(FronosBlocks.fronos_block, 1, 1), new ItemStack(Blocks.vine) );
        ...
        // Block smelting
        GameRegistry.addSmelting(new ItemStack(DionaBlocks.diona_block, 1, 3), new ItemStack(DionaBlocks.diona_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(PolongniusBlocks.polongnius_block, 1, 3), new ItemStack(PolongniusBlocks.polongnius_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(PolongniusBlocks.polongnius_block, 1, 14), new ItemStack(PolongniusBlocks.polongnius_block, 1, 15), 0.1F);
        GameRegistry.addSmelting(new ItemStack(NibiruBlocks.nibiru_block, 1, 3), new ItemStack(NibiruBlocks.nibiru_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(KoentusBlocks.koentus_block, 1, 3), new ItemStack(KoentusBlocks.koentus_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 1), new ItemStack(FronosBlocks.fronos_block, 1, 0), 0.1F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_sand, 1, 0), new ItemStack(Blocks.stained_glass, 1, 3), 0.1F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_sand, 1, 1), new ItemStack(Blocks.stained_glass, 1, 0), 0.1F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_sand, 1, 2), new ItemStack(FronosBlocks.cheese_glass), 0.1F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 11), new ItemStack(FronosBlocks.fronos_block, 1, 12), 0.1F);
        GameRegistry.addSmelting(new ItemStack(KapteynBBlocks.kapteyn_b_block, 1, 3), new ItemStack(KapteynBBlocks.kapteyn_b_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(SiriusBBlocks.sirius_b_block, 1, 3), new ItemStack(SiriusBBlocks.sirius_b_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(MercuryBlocks.mercury_block, 1, 3), new ItemStack(MercuryBlocks.mercury_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 3), new ItemStack(VenusBlocks.venus_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 12), new ItemStack(VenusBlocks.venus_block, 1, 13), 0.1F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_sand), new ItemStack(Blocks.glass), 0.1F);
        GameRegistry.addSmelting(new ItemStack(PlutoBlocks.pluto_block, 1, 3), new ItemStack(PlutoBlocks.pluto_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(PhobosBlocks.phobos_block, 1, 3), new ItemStack(PhobosBlocks.phobos_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(DeimosBlocks.deimos_block, 1, 3), new ItemStack(DeimosBlocks.deimos_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(IoBlocks.io_block, 1, 3), new ItemStack(IoBlocks.io_block, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(IoBlocks.io_block, 1, 6), new ItemStack(IoBlocks.io_block, 1, 5), 0.1F);
        GameRegistry.addSmelting(new ItemStack(EuropaBlocks.europa_sand), new ItemStack(Blocks.stained_glass, 1, 9), 0.1F);
        GameRegistry.addSmelting(new ItemStack(EuropaBlocks.europa_sponge, 1, 1), new ItemStack(EuropaBlocks.europa_sponge, 1, 0), 0.15F);

        // Item smelting
        GameRegistry.addSmelting(new ItemStack(DionaBlocks.diona_block, 1, 4), new ItemStack(DionaItems.diona_item, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(DionaBlocks.diona_block, 1, 5), new ItemStack(DionaItems.diona_item, 1, 1), 0.7F);
        GameRegistry.addSmelting(new ItemStack(DionaBlocks.diona_block, 1, 6), new ItemStack(GCItems.basicItem, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(DionaBlocks.diona_block, 1, 7), new ItemStack(GCItems.basicItem, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(DionaBlocks.diona_block, 1, 8), new ItemStack(GCItems.basicItem, 1, 2), 0.7F);
        GameRegistry.addSmelting(new ItemStack(DionaBlocks.diona_block, 1, 9), new ItemStack(GCItems.basicItem, 1, 5), 0.7F);
        ...
        GameRegistry.addSmelting(new ItemStack(PolongniusBlocks.polongnius_block, 1, 9), new ItemStack(PolongniusItems.polongnius_item, 1, 1), 0.7F);
        GameRegistry.addSmelting(new ItemStack(PolongniusBlocks.polongnius_block, 1, 10), new ItemStack(PolongniusItems.cheese_food, 1, 0), 0.2F);
        ...
        GameRegistry.addSmelting(new ItemStack(PolongniusItems.cheese_food, 1, 1), new ItemStack(PolongniusItems.cheese_food, 1, 2), 0.35F);
        GameRegistry.addSmelting(new ItemStack(NibiruBlocks.nibiru_block, 1, 4), new ItemStack(NibiruItems.power_crystal), 0.7F);
        GameRegistry.addSmelting(new ItemStack(NibiruBlocks.nibiru_block, 1, 5), new ItemStack(NibiruItems.nibiru_item, 1, 1), 0.7F);
        GameRegistry.addSmelting(new ItemStack(NibiruBlocks.nibiru_block, 1, 6), new ItemStack(Items.diamond), 1.0F);
        GameRegistry.addSmelting(new ItemStack(NibiruBlocks.nibiru_block, 1, 7), new ItemStack(Items.coal), 0.1F);
        GameRegistry.addSmelting(new ItemStack(NibiruBlocks.nibiru_block, 1, 8), new ItemStack(NibiruItems.nibiru_item, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KoentusBlocks.koentus_block, 1, 4), new ItemStack(GCItems.basicItem, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KoentusBlocks.koentus_block, 1, 5), new ItemStack(GCItems.basicItem, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KoentusBlocks.koentus_block, 1, 6), new ItemStack(KoentusItems.koentus_item, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KoentusBlocks.koentus_block, 1, 7), new ItemStack(KoentusItems.koentus_item, 1, 1), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KoentusBlocks.koentus_block, 1, 8), new ItemStack(KoentusItems.koentus_item, 1, 2), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KoentusBlocks.fallen_koentus_meteor), new ItemStack(KoentusItems.koentus_item, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KoentusItems.koentus_item, 1, 3), new ItemStack(KoentusItems.koentus_item, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(FronosItems.fronos_food, 1, 2), new ItemStack(FronosItems.fronos_food, 1, 3), 0.35F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 0), new ItemStack(FronosItems.jelly, 1, 0), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 1), new ItemStack(FronosItems.jelly, 1, 1), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 2), new ItemStack(FronosItems.jelly, 1, 2), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 3), new ItemStack(FronosItems.jelly, 1, 3), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 4), new ItemStack(FronosItems.jelly, 1, 4), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 5), new ItemStack(FronosItems.jelly, 1, 5), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 6), new ItemStack(FronosItems.jelly, 1, 6), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.jelly_ore, 1, 7), new ItemStack(FronosItems.jelly, 1, 7), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 2), new ItemStack(Items.iron_ingot), 0.7F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 3), new ItemStack(Items.coal), 0.1F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 4), new ItemStack(GCItems.basicItem, 1, 5), 0.7F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 5), new ItemStack(GCItems.basicItem, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 6), new ItemStack(GCItems.basicItem, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 7), new ItemStack(Items.dye, 1, 4), 0.2F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 8), new ItemStack(FronosItems.fronos_item, 1, 0), 1.0F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 9), new ItemStack(FronosItems.fronos_item, 1, 2), 1.0F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block, 1, 10), new ItemStack(FronosItems.fronos_item, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 0), new ItemStack(Items.gold_ingot), 1.0F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 1), new ItemStack(Items.diamond), 1.0F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 2), new ItemStack(Items.emerald), 1.0F);
        GameRegistry.addSmelting(new ItemStack(FronosBlocks.fronos_block1, 1, 3), new ItemStack(GCItems.basicItem, 1, 2), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KapteynBBlocks.kapteyn_b_block, 1, 4), new ItemStack(KapteynBItems.namerium_crystal, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KapteynBBlocks.kapteyn_b_block, 1, 5), new ItemStack(KapteynBItems.kapteyn_b_item, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KapteynBBlocks.kapteyn_b_block, 1, 6), new ItemStack(KapteynBItems.kapteyn_b_item, 1, 1), 1.0F);
        GameRegistry.addSmelting(new ItemStack(KapteynBBlocks.kapteyn_b_block, 1, 7), new ItemStack(GCItems.basicItem, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KapteynBBlocks.kapteyn_b_block, 1, 8), new ItemStack(GCItems.basicItem, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(KapteynBBlocks.kapteyn_b_redstone_ore), new ItemStack(Items.redstone), 0.7F);
        ...
        GameRegistry.addSmelting(new ItemStack(SiriusBBlocks.sirius_b_block, 1, 5), new ItemStack(Items.diamond), 1.0F);
        GameRegistry.addSmelting(new ItemStack(SiriusBBlocks.sirius_b_block, 1, 6), new ItemStack(SiriusBItems.sirius_glowstone_dust), 0.5F);
        GameRegistry.addSmelting(new ItemStack(MercuryBlocks.mercury_block, 1, 4), new ItemStack(GCItems.basicItem, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MercuryBlocks.mercury_block, 1, 5), new ItemStack(GCItems.basicItem, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MercuryBlocks.mercury_block, 1, 6), new ItemStack(GCItems.basicItem, 1, 5), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MercuryBlocks.mercury_block, 1, 7), new ItemStack(Items.iron_ingot), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MercuryBlocks.mercury_block, 1, 8), new ItemStack(MercuryItems.mercury_item, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MercuryBlocks.metallic_rock), new ItemStack(MercuryItems.mercury_item, 1, 2), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MercuryItems.mercury_item, 1, 0), new ItemStack(MercuryItems.mercury_item, 1, 2), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MercuryItems.mercury_item, 1, 1), new ItemStack(MercuryItems.mercury_item, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(MPBlocks.chondrite_rock, 1, 0), new ItemStack(MPBlocks.chondrite_rock, 1, 2), 0.1F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 4), new ItemStack(SiriusBItems.sirius_b_item, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 5), new ItemStack(VenusItems.venus_item, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 6), new ItemStack(GCItems.basicItem, 1, 4), 0.7F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 7), new ItemStack(GCItems.basicItem, 1, 3), 0.7F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 8), new ItemStack(Items.coal), 0.1F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 9), new ItemStack(Items.iron_ingot), 0.7F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_block, 1, 10), new ItemStack(Items.gold_ingot), 1.0F);
        GameRegistry.addSmelting(new ItemStack(VenusBlocks.venus_redstone_ore), new ItemStack(Items.redstone), 0.7F);
        GameRegistry.addSmelting(new ItemStack(PlutoBlocks.pluto_block, 1, 4), new ItemStack(GCItems.meteoricIronIngot), 0.7F);
        GameRegistry.addSmelting(new ItemStack(PlutoBlocks.pluto_block, 1, 5), new ItemStack(KapteynBItems.kapteyn_b_item, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(PlutoBlocks.pluto_block, 1, 6), new ItemStack(Items.iron_ingot), 0.7F);
        GameRegistry.addSmelting(new ItemStack(PlutoBlocks.pluto_block, 1, 7), new ItemStack(PlutoItems.pluto_item, 1, 0), 0.7F);
        GameRegistry.addSmelting(new ItemStack(PlutoItems.space_potato, 1, 0), new ItemStack(PlutoItems.space_potato, 1, 1), 0.35F);
        ...
        GameRegistry.addSmelting(new ItemStack(PhobosBlocks.phobos_block, 1, 6), new ItemStack(Items.iron_ingot), 0.7F);
        GameRegistry.addSmelting(new ItemStack(PhobosBlocks.phobos_block, 1, 7), new ItemStack(MarsItems.marsItemBasic, 1, 2), 0.7F);
        ...
        GameRegistry.addSmelting(new ItemStack(DeimosBlocks.deimos_block, 1, 6), new ItemStack(Items.iron_ingot), 0.7F);
        GameRegistry.addSmelting(new ItemStack(DeimosBlocks.deimos_block, 1, 7), new ItemStack(MarsItems.marsItemBasic, 1, 2), 0.7F);
        ...
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane1, 1, 0), new ItemStack(FronosItems.candy_cane, 4, 0), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane1, 1, 1), new ItemStack(FronosItems.candy_cane, 4, 1), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane1, 1, 2), new ItemStack(FronosItems.candy_cane, 4, 2), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane1, 1, 3), new ItemStack(FronosItems.candy_cane, 4, 3), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane2, 1, 0), new ItemStack(FronosItems.candy_cane, 4, 4), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane2, 1, 1), new ItemStack(FronosItems.candy_cane, 4, 5), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane2, 1, 2), new ItemStack(FronosItems.candy_cane, 4, 6), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.candy_cane2, 1, 3), new ItemStack(FronosItems.candy_cane, 4, 7), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.frosted_cake, 1, 0), new ItemStack(FronosBlocks.cake_bread), 0.5F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.frosted_cake, 1, 1), new ItemStack(FronosBlocks.white_cake_bread), 0.5F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.frosted_cake, 1, 2), new ItemStack(FronosBlocks.chocolate_cake_bread), 0.5F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.frosted_cake, 1, 3), new ItemStack(Items.cake), 0.5F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.frosted_cake, 1, 4), new ItemStack(FronosBlocks.pink_cake), 0.5F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.frosted_cake, 1, 5), new ItemStack(FronosBlocks.white_cake), 0.5F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.frosted_cake, 1, 6), new ItemStack(FronosBlocks.chocolate_cake), 0.5F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_block, 1, 0), new ItemStack(FronosItems.jelly, 4, 0), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_block, 1, 1), new ItemStack(FronosItems.jelly, 4, 1), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_block, 1, 2), new ItemStack(FronosItems.jelly, 4, 2), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_block, 1, 3), new ItemStack(FronosItems.jelly, 4, 3), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_block, 1, 4), new ItemStack(FronosItems.jelly, 4, 4), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_block, 1, 5), new ItemStack(FronosItems.jelly, 4, 5), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_block, 1, 6), new ItemStack(FronosItems.jelly, 4, 6), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 0), new ItemStack(FronosItems.jelly, 4, 0), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 1), new ItemStack(FronosItems.jelly, 4, 1), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 2), new ItemStack(FronosItems.jelly, 4, 2), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 3), new ItemStack(FronosItems.jelly, 4, 3), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 4), new ItemStack(FronosItems.jelly, 4, 4), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 5), new ItemStack(FronosItems.jelly, 4, 5), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 6), new ItemStack(FronosItems.jelly, 4, 6), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.jelly_slime_egg, 1, 7), new ItemStack(FronosItems.jelly, 4, 7), 0.2F);
        CandyExtractorRecipes.instance().addExtractingRecipe(new ItemStack(FronosBlocks.chocolate_block), new ItemStack(FronosItems.candy_food, 4, 1), 0.2F);
    ...
    private static void registerTier4RocketRecipe()
    {
        ...
        ItemStack t4Plate = EnumItemUtil.Tier4ItemType.T4_PLATE.getItemStack();

        input.put(1, EnumItemUtil.Tier4ItemType.NOSE_CONE.getItemStack());
        input.put(2, t4Plate);
        input.put(3, t4Plate);
        input.put(4, t4Plate);
        input.put(5, t4Plate);
        ...
        input.put(12, EnumItemUtil.Tier4ItemType.T4_BOOSTER.getItemStack());
        input.put(13, new ItemStack(AsteroidsItems.basicItem, 1, 2));
        input.put(14, new ItemStack(AsteroidsItems.basicItem, 1, 2));
        input.put(15, EnumItemUtil.Tier4ItemType.T4_ENGINE.getItemStack());
        input.put(16, EnumItemUtil.Tier4ItemType.T4_BOOSTER.getItemStack());
