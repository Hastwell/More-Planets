...
//
//public class ChunkProviderBaseMP extends ChunkProviderGenerate
//{
...
//
//		for (int x = 0; x < ChunkProviderBaseMP.CHUNK_SIZE_X; x++)
//		{
//			for (int z = 0; z < ChunkProviderBaseMP.CHUNK_SIZE_Z; z++)
//			{
...
//				}
//
//				for (int y = 0; y < ChunkProviderBaseMP.CHUNK_SIZE_Y; y++)
//				{
//					if (y < ChunkProviderBaseMP.MID_HEIGHT + yDev)
//					{
...
//					for (int z = 0; z < ChunkProviderBaseMP.CHUNK_SIZE_Z; z++)
//					{
//						if (Math.abs(this.randFromPoint(cx * 16 + x, (cz * 16 + z) * 1000)) < this.noiseGen4.getNoise(x * ChunkProviderBaseMP.CHUNK_SIZE_X + x, cz * ChunkProviderBaseMP.CHUNK_SIZE_Z + z) / ChunkProviderBaseMP.CRATER_PROB)
//						{
