...
public class BlockStoneSlab1MP extends BlockSlab
{
	public static PropertyEnum VARIANT = PropertyEnum.create("variant", BlockType.class);

	public BlockStoneSlab1MP(String name, Material material)
	{
		super(material);
	...
	public BlockStoneSlab1MP(Material material)
	{
		super(material);
	}
	...
	public float getBlockHardness(World world, BlockPos pos)
	{
		...
		if (!(block instanceof BlockStoneSlab1MP))
		{
			return 0.0F;
		}
