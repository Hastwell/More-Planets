...
public abstract class BlockSnowLayerMP extends BlockBaseMP
{
	...
	{
		return this.getItemMetadataDropped();
	}
	...
	protected abstract Item getItemDropped();
	protected abstract int getItemMetadataDropped();
}