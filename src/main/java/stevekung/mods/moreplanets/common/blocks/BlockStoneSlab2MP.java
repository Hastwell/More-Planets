...
public class BlockStoneSlab2MP extends BlockSlab
{
	public static PropertyEnum VARIANT = PropertyEnum.create("variant", BlockType.class);

	public BlockStoneSlab2MP(String name, Material material)
	{
		super(material);
	...
	public BlockStoneSlab2MP(Material material)
	{
		super(material);
	}
	...
	{
		fronos_cobblestone_slab(0),
		fronos_stone_brick_slab(1),
