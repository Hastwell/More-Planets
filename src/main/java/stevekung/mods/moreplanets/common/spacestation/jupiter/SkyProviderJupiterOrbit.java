...
public class SkyProviderJupiterOrbit extends IRenderHandler
{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		var23.getWorldRenderer().startDrawingQuads();
		var23.getWorldRenderer().addVertexWithUV(-size, -100.0D, size, var18, var19);
		var23.getWorldRenderer().addVertexWithUV(size, -100.0D, size, var16, var19);
		var23.getWorldRenderer().addVertexWithUV(size, -100.0D, -size, var16, var17);
		var23.getWorldRenderer().addVertexWithUV(-size, -100.0D, -size, var18, var17);
		var23.draw();
