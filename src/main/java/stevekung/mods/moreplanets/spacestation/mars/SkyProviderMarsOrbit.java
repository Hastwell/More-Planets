...
//{
//    private ResourceLocation moonTexture = new ResourceLocation("moreplanets:textures/gui/celestialbodies/mars.png");
...
//                worldrenderer.func_181662_b(j + 0, f, l + 0);
//                worldrenderer.func_181662_b(j + byte2, f, l + 0);
//                worldrenderer.func_181662_b(j + byte2, f, l + byte2);
//                worldrenderer.func_181662_b(j + 0, f, l + byte2);
//                tessellator.draw();
//            }
//        }
//
...
//            {
//                worldrenderer.func_181662_b(k + byte2, f, i1 + 0);
//                worldrenderer.func_181662_b(k + 0, f, i1 + 0);
//                worldrenderer.func_181662_b(k + 0, f, i1 + byte2);
//                worldrenderer.func_181662_b(k + byte2, f, i1 + byte2);
//            }
//        }
//        tessellator.draw();
//        GL11.glEndList();
...
//            }
//
//            var23.getWorldRenderer().startDrawing(6, DefaultVertexFormats.field_181707_g);
//            var23.getWorldRenderer().setColorRGBA_F(var8, var9, var10, var24[3]);
//            var23.getWorldRenderer().func_181662_b(0.0D, 100.0D, 0.0D);
//            byte var26 = 16;
//            var23.getWorldRenderer().setColorRGBA_F(var24[0], var24[1], var24[2], 0.0F);
//
...
//                var23.getWorldRenderer().func_181662_b(var14 * 120.0F, var15 * 120.0F, -var15 * 40.0F * var24[3]);
//            }
//            var23.draw();
//            GL11.glPopMatrix();
...
//            var23.getWorldRenderer().func_181662_b(-var12, 99.9D, -var12);
//            var23.getWorldRenderer().func_181662_b(var12, 99.9D, -var12);
//            var23.getWorldRenderer().func_181662_b(var12, 99.9D, var12);
//            var23.getWorldRenderer().func_181662_b(-var12, 99.9D, var12);
//            var23.draw();
...
//            var23.getWorldRenderer().startDrawingQuads();
//            var23.getWorldRenderer().func_181662_bWithUV(-var12, 100.0D, -var12, 0.0D, 0.0D);
//            var23.getWorldRenderer().func_181662_bWithUV(var12, 100.0D, -var12, 1.0D, 0.0D);
//            var23.getWorldRenderer().func_181662_bWithUV(var12, 100.0D, var12, 1.0D, 1.0D);
//            var23.getWorldRenderer().func_181662_bWithUV(-var12, 100.0D, var12, 0.0D, 1.0D);
//            var23.draw();
//        }
//
//        GL11.glPopMatrix();
...
//        var23.getWorldRenderer().startDrawingQuads();
//        var23.getWorldRenderer().func_181662_bWithUV(-size, -100.0D, size, 0.0D, 0.0D);
//        var23.getWorldRenderer().func_181662_bWithUV(size, -100.0D, size, 1.0D, 0.0D);
//        var23.getWorldRenderer().func_181662_bWithUV(size, -100.0D, -size, 1.0D, 1.0D);
//        var23.getWorldRenderer().func_181662_bWithUV(-size, -100.0D, -size, 0.0D, 1.0D);
//        var23.draw();
//
//        GL11.glDisable(GL11.GL_TEXTURE_2D);
//        GL11.glPopMatrix();
...
//                    var2.getWorldRenderer().func_181662_b(var14 + var57, var16 + var53, var18 + var61);
//                }
//            }
//        }
//        var2.draw();
